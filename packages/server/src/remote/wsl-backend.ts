...
import type { WSLConnectOptions } from "@kcode/shared";
import type {
  IRemoteBackend,
  RemoteEnvironment,
  RemoteUploadOptions,
...
import { isWSLAvailable, listWSLDistros, type WSLDistro } from "@kcode/server/remote/wsl-detect.js";
import {
...
} from "@kcode/server/remote/wslProxy.js";
