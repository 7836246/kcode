...
import { createUuid, type RemoteTarget, type RemoteWorkspaceSessionEntry } from "@kcode/shared";
import {
                ...
                {currentStep === "directory" ? (
                  <div data-testid={TID_SSH_SUCCESS} className="h-full">
                    <RemoteConnectionDirectoryStep
                      ...
                      remoteKCodeAgentService={directoryBrowserServices?.kcodeAgentService ?? null}
