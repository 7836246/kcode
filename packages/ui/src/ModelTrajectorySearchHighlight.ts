...
const HIGHLIGHT_NAME = "kcode-model-trajectory-find";
const ACTIVE_HIGHLIGHT_NAME = "kcode-model-trajectory-find-active";
const STYLE_ID = "kcode-model-trajectory-find-highlight-style";
