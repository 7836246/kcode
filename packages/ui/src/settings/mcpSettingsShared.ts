import type { McpServerConfig, KCodeMcpServer } from "@kcode/shared";

export const MCP_SECTIONS = ["kcodeagentmcp"] as const;
...
export function serverToForm(server: KCodeMcpServer): FormState {
...
// 与 shared 层 convertToKCodeAgentMcpServer 的 isMcpProtocolVersion 守卫保持同一语义：
