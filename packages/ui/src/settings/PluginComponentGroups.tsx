import type { KCodePluginComponentKind } from "@kcode/shared";
...
const COMPONENT_BADGE_STYLES: Record<KCodePluginComponentKind, string> = {
...
const COMPONENT_LABEL_IDS: Record<KCodePluginComponentKind, string> = {
