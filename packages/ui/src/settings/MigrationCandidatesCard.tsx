...
import type {
  ...
  KCodeImportedSessionSkippedItem,
} from "@kcode/shared";
...
function ImportIssuesList({
  ...
  title: string;
  items: KCodeImportedSessionSkippedItem[];
}) {
...
export function MigrationCandidatesCard({
  ...
  candidates: KCodeImportableSessionCandidate[];
  selectedSessionIds: string[];
  selectedCount: number;
  importError: string | null;
  lastImportResult: KCodeImportSessionsResult | null;
  isImporting: boolean;
