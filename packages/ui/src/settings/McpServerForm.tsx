...
import type { McpSource, KCodeMcpServer } from "@kcode/shared";
...
export function McpServerForm({
  ...
  onSave: (form: FormState, prevServer?: KCodeMcpServer) => void;
  onCancel: () => void;
  onDelete?: (server: KCodeMcpServer) => void;
}) {
  const { intl } = useKCodeIntl();
