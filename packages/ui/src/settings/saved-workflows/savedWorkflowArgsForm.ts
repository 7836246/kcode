...
import type { KCodeSavedWorkflowArgType, KCodeSavedWorkflowArgsDeclaration } from "@kcode/shared";

export interface SavedWorkflowArgField {
  name: string;
  type: KCodeSavedWorkflowArgType;
  description?: string;
  required: boolean;
  hasDefault: boolean;
...
function formatSavedWorkflowArgValue(type: KCodeSavedWorkflowArgType, value: unknown): string {
...
export function buildSavedWorkflowArgFields(
  declaration: KCodeSavedWorkflowArgsDeclaration | undefined,
...
type SavedWorkflowArgRowsCollect =
  | { ok: true; args: KCodeSavedWorkflowArgsDeclaration | undefined }
...
export function rowsToArgsDeclaration(
  ...
  const args: KCodeSavedWorkflowArgsDeclaration = {};
