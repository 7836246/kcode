...
import type { KCodePluginMarketplaceSummary } from "@kcode/shared";
...
function isRemovableMarketplace(marketplace: KCodePluginMarketplaceSummary): boolean {
...
function PluginStoreSourceRefreshFailure({
  ...
  failure: NonNullable<KCodePluginMarketplaceSummary["refreshFailure"]>;
}) {
