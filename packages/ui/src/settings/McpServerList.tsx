...
function McpServerItem({
  ...
  server: KCodeMcpServer;
  onEdit: (server: KCodeMcpServer) => void;
  onToggle: (id: string, enabled: boolean) => void;
  onOpenAuthorization?: (server: KCodeMcpServer) => void;
  ...
  const canEdit = !server.location || server.location.source === "kcode";
