...
import type { KCodePluginDiagnostic, KCodePluginInfo } from "@kcode/shared";
 ...
 */
export function PluginWarningList({ warnings }: { warnings: KCodePluginDiagnostic[] }) {
  return (
...
export function PluginHookDetails({
  ...
  hooks: NonNullable<KCodePluginInfo["hookDetails"]>;
}) {
...
function formatHookCommand(hook: NonNullable<KCodePluginInfo["hookDetails"]>[number]): string {
