...
import { unpackWorkspaceFileEntries } from "@kcode/shared/workspaceFileEntriesCodec";
...
import type { WorkspaceFileEntry, KCodeTaskChangeSummary, KCodeTaskMeta } from "@kcode/shared";
import {
  Command,
  CommandDialog,
  CommandEmpty,
...
type TaskSearchResultItem = KCodeTaskMeta & {
  searchSnippet?: string;
  searchSnippets?: string[];
};
type TaskChangedFileSummary = KCodeTaskChangeSummary["files"][number];
...
function getTaskTitle(task: KCodeTaskMeta, untitledLabel: string): string {
