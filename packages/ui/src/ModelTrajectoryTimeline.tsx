...
import type { KCodeModelTrajectoryRecord } from "@kcode/services";
import {
...
export function resolveTrajectoryTimelineItems(records: KCodeModelTrajectoryRecord[]) {
...
export function resolveTrajectoryInputMessages({
  ...
  inputMessages: KCodeModelTrajectoryRecord["request"]["messages"];
...
function shouldUseConversationDelta(record: KCodeModelTrajectoryRecord): boolean {
  const kind = record.callSource?.kind;
  return kind === undefined || kind === "main" || kind === "subagent";
}

function computeDeltaMessages(
  messages: KCodeModelTrajectoryRecord["request"]["messages"],
  previousMessageCount: number,
  index: number,
): KCodeModelTrajectoryRecord["request"]["messages"] {
