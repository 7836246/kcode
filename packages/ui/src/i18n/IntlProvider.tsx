...
import type { Locale, LocalePreference } from "@kcode/shared";
import { DEFAULT_LOCALE } from "@kcode/shared";
import type { BroadcastMessage, IBroadcastService, ISettingService } from "@kcode/services";
import {
...
const LOCALE_PREFERENCE_KEY = "kcode-locale-preference";
 ...
 */
export function KCodeIntlProvider({
  children,
  settingService,
  broadcastService,
  initialLocale,
...
/** 获取 intl 上下文 */
export function useKCodeIntl(): IntlContextValue {
  const ctx = useContext(IntlContext);
  if (!ctx) {
    throw new Error("useKCodeIntl 必须在 KCodeIntlProvider 内使用");
  }
  return ctx;
}
