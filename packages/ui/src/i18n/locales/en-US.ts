...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like KCode to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let KCode remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting KCode",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen KCode.",
  ...
  "startup.global.starting_services": "Starting KCode",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "KCode will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another KCode or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen KCode. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen KCode to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen KCode.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a KCode restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into KCode",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to KCode and try again",
  ...
  "quickPick.command.feedback": "Report on GitHub",
  ...
  "bots.title": "Bots",
  "bots.description": "Connect external chats and webhooks to KCode bots.",
  "bots.listTitle": "Bots",
  "bots.addBot": "New bot",
  ...
  "bots.setup.guide.weixin.create.2":
    "KCode saves the bot_token returned by iLink automatically; after scanning, send any message to the bot in Weixin to activate the chat.",
  "bots.setup.guide.weixin.create.3":
    "KCode uses a built-in iLink client: `/ilink/bot/getupdates` for long polling and `/ilink/bot/sendmessage` for replies.",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook mode does not require a native bot in the third-party product; your integration only needs to POST messages to KCode.",
  ...
  "bots.setup.guide.webhook.bind.1":
    "POST a private-message callback to KCode's `/api/bots/webhook` endpoint.",
  ...
  "bots.setup.guide.webhook.bind.3":
    "If the bot uses a secret, also send `x-kcode-bot-secret`; then return here after the bind succeeds.",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere":
    "Telegram long polling is handled by another KCode window.",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to KCode",
  ...
  "logout.confirm.title": "Disconnect and restart KCode?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only KCode Agent writes model-io)",
  ...
  "workspaceHeader.help.issueReport": "Report on GitHub",
  ...
  "titleBar.menu.help.about": "About KCode",
  "titleBar.menu.help.checkForUpdates": "Check for updates",
  "titleBar.menu.help.feedback": "Report on GitHub",
  ...
  "titleBar.menu.help.toggleKCodeStdioTap": "Capture agent stdio traffic",
  ...
  "forceUpdate.title": "Update KCode to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart KCode to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the KCode CDN and have download, extract, and checksum tools.",
  ...
  "remoteConnection.feedback": "Report on GitHub",
  ...
  "webRemoteControl.description": "Control KCode workspaces through chat bots.",
  ...
  "taskList.feedback": "Report on GitHub",
  "taskList.viewModelTrajectory": "View model trajectory",
  "taskList.feedbackOpened": "Opened GitHub Issues",
  ...
  "chat.changeSummary.rewindDialog.description":
    "KCode checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the KCode terminal font.",
  ...
  "settings.managedSystemRole.editorHint":
    "This edits ~/.kcode/system-role.md. Preview shows the current draft; a new conversation picks up the saved text. Long text scrolls inside the box.",
  "settings.managedSystemRole.preset.label": "Presets",
  "settings.managedSystemRole.preset.default": "Default",
  "settings.managedSystemRole.preset.unrestricted": "Unrestricted",
  "settings.managedSystemRole.preset.add": "Add preset",
  ...
  "settings.kcodeInteractionBehavior": "Interaction behavior",
  "settings.kcodeInteractionBehaviorDescription":
    "While KCode is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  "settings.kcodeInteractionBehavior.option.queue": "Queue",
  "settings.kcodeInteractionBehavior.option.guide": "Guide",
  ...
  "settings.dataBaseDirDescription":
    "Root directory for app data (defaults to user home directory). Existing data will be copied to the new location. The .kcode/v2 suffix cannot be changed.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the KCode installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching KCode task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by KCode",
  ...
  "resourceManager.storage.diskUsage": "KCode uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the KCode desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "KCode could not verify its Windows secure import component. Reinstall or update KCode before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, KCode will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by KCode Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "KCode provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This KCode Agent cannot refresh OAuth status. Upgrade or restart KCode, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to KCode to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into KCode",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. KCode uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.modelProvider.fetchingModels": "Fetching models",
  "settings.modelProvider.fetchModelsListed": "{count} remote models found. Choose which to add.",
  "settings.modelProvider.fetchModelsDialogTitle": "Select models to add",
  "settings.modelProvider.fetchModelsDialogDescription":
    "{total} remote models found. {added} are already in this list. New models are unchecked by default.",
  "settings.modelProvider.fetchModelsSearchPlaceholder": "Search model ID",
  "settings.modelProvider.fetchModelsSearchEmpty": "No matching models",
  "settings.modelProvider.fetchModelsSelectedCount": "{count} new models selected",
  "settings.modelProvider.fetchModelsSelectVisible": "Select visible",
  "settings.modelProvider.fetchModelsDeselectVisible": "Clear visible",
  "settings.modelProvider.fetchModelsAlreadyAdded": "Added",
  "settings.modelProvider.fetchModelsConfirm": "Add {count} models",
  "settings.modelProvider.fetchModelsSuccess": "Added {added} models",
  "settings.modelProvider.fetchModelsEmpty": "No new models to add",
  "settings.modelProvider.fetchModelsFailure": "Failed to fetch models: {error}",
  "settings.modelProvider.clearModels": "Clear",
  "settings.modelProvider.clearModelsConfirmTitle": "Clear all models?",
  "settings.modelProvider.clearModelsConfirmDescription":
    "This removes every model from this provider. The Base URL and API key stay.",
  "settings.modelProvider.clearModelsConfirmAction": "Clear",
  "settings.modelProvider.clearModelsSuccess": "Model list cleared",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in KCode after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "KCode MCP",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into KCode. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. KCode follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into KCode",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by KCode Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend KCode with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into KCode and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. KCode follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into KCode",
  ...
  "settings.commands.description":
    "Manage KCode Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.kcodeAgent": "KCode Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into KCode. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. KCode follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into KCode",
  ...
  "settings.workspaceFileSearch.description":
    "Edit .kcodeignore rules (gitignore syntax) that scope workspace file search. Takes effect on the next search after saving.",
  "settings.workspaceFileSearch.templateHint":
    ".kcodeignore does not exist yet: the content below is the initial preview (.gitignore copy + default exclusions); it is written to the workspace only after saving.",
  ...
  "settings.workspaceFileSearch.revealHint": "Save first; .kcodeignore lives at the workspace root",
  ...
  "settingsSync.action.finish": "Start using KCode",
  "settingsSync.agent.kcode": "KCode Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current KCode settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to KCode",
  ...
  "onboarding.welcome.title": "Welcome to KCode",
  "onboarding.welcome.start": "Start KCode",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while KCode imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "KCode will copy {source} to {target}.\nIf the target file already exists, the KCode default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask KCode anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask KCode anything…",
  ...
  // Composer prompt-enhance entry; section strings live under settings.promptEnhance.*
  "chat.toolbar.promptEnhance.label": "Enhance prompt",
  "chat.toolbar.promptEnhance.running": "Enhancing {seconds}s",
  "chat.toolbar.promptEnhance.startTooltip":
    "Rewrite this draft with a model and put it back in the composer without sending",
  "chat.toolbar.promptEnhance.cancelTooltip": "Click again to cancel this enhancement",
  "chat.toolbar.promptEnhance.restoreLabel": "Restore",
  "chat.toolbar.promptEnhance.restoreTooltip": "Go back to the text from before the enhancement",
  ...
  "chat.toolbar.promptEnhance.success": "Enhanced ({seconds}s · {model})",
  ...
  "chat.modelFallback.switched": "Switched to {model}",
  "settings.modelFallback.title": "Backup models",
  "settings.modelFallback.description":
    "If the current model times out, is rate limited, or returns a server error, continue the same turn in this order. Authentication errors and content refusals stay on the current model.",
  "settings.modelFallback.empty": "No backup models",
  "settings.modelFallback.add": "Add a backup model",
  "settings.modelFallback.remove": "Remove",
  "settings.modelFallback.moveUp": "Move up",
  "settings.modelFallback.moveDown": "Move down",
  ...
  "settings.promptEnhance.channel.provider": "Provider",
  "settings.promptEnhance.channel.providerPlaceholder": "Choose a provider",
  "settings.promptEnhance.channel.model": "Model",
  "settings.promptEnhance.channel.modelPlaceholder": "Choose a model",
  "settings.promptEnhance.reasoning.label": "Reasoning effort",
  "settings.promptEnhance.reasoning.note": "Only applies to the dedicated channel",
  "settings.promptEnhance.reasoning.default": "Default",
  "settings.promptEnhance.reasoning.low": "Low",
  ...
  "settings.promptEnhance.prompt.hide": "Hide",
  "settings.promptEnhance.reset": "Restore defaults",
  "settings.promptEnhance.saveError": "Settings were not saved",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, KCode will continue switching models.",
  ...
  "chat.toolbar.mode.approvalTitle": "How should KCode actions be approved?",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want KCode to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart KCode app and retry, or ask KCode to investigate the logs",
  ...
  "chat.toolbar.mode.description":
    "Choose how KCode should ask before editing files or using the internet.",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with KCode in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for KCode: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with KCode in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current KCode Agent session",
  ...
  "chat.error.feedback": "Report on GitHub",
  "chat.error.feedbackOpened": "Opened GitHub Issues",
  "chat.error.noAvailableModel": "No model available. Configure a provider and model first.",
  ...
  "chat.quota.mcp.quotaExhausted":
    'KCode MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No KCode MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  // Modes
  "mode.plan": "Plan",
  "mode.label.glm.build": "Ask first",
  "mode.label.glm.edit": "Approve for me",
  "mode.label.glm.plan": "Plan mode",
  "mode.label.glm.yolo": "Full access",
  "mode.description.glm.build": "Always ask when editing files or using the internet",
  "mode.description.glm.edit": "Only ask about detected risky actions",
  "mode.description.glm.plan": "Plan before editing.",
  "mode.description.glm.yolo": "Unrestricted access to the internet and any files on this computer",
  ...
  // KCode Agent
  "kcode.unavailable": "AI agent not available",
  "kcode.initFailed": "Failed to start AI agent",
  "kcode.error.TASK_OWNED_BY_OTHER_HOST": "This task is already running in another connected view.",
  "kcode.error.STALE_TASK_OWNER_COMMAND": "This action belongs to an older run and was ignored.",
  "kcode.error.NO_ACTIVE_TASK_OWNER": "No active task owner is available for this action.",
  "kcode.error.OWNER_COMMAND_FAILED": "The task owner could not complete this action.",
  "kcode.error.MEDIA_BUDGET_CURRENT_ATTACHMENT_TOO_LARGE":
    "Current attachments are too large for one request. Remove or compress attachments and try again.",
  "kcode.error.MEDIA_BUDGET_CURRENT_IMAGE_TOO_LARGE":
    "Current image attachments are too large. Remove or compress images and try again.",
  "kcode.error.MEDIA_BUDGET_CURRENT_VIDEO_TOO_LARGE":
    "Current video attachments are too large. Remove or compress videos and try again.",
  "kcode.error.KCODE_RUNTIME_MODEL_UNAVAILABLE":
    "The current model is no longer available. Select an available model from the current model list to continue.",
  "kcode.error.KCODE_BIGMODEL_TEAM_PLAN_MEMBER_REQUIRED":
    "The current model is unavailable. Check whether the current account has been added to the project member list.",
  "kcode.error.providerBusiness.1006": "Your login session has expired. Please sign in again.",
  "kcode.error.providerBusiness.1005":
    "Today's free plan quota has been used up. Upgrade to continue now, or wait for the quota to reset.",
  "kcode.error.providerBusiness.3006":
    "The current model is not included in this plan. Switch to an allowed model and try again.",
  "kcode.error.providerBusiness.3002":
    "You're sending requests too quickly. Please try again later.",
  "kcode.error.providerBusiness.3001":
    "The request parameters are invalid. Check the input and try again.",
  "kcode.error.providerBusiness.3007":
    "The request was rejected by the gateway security check. Please try again later or contact support.",
  "kcode.error.providerBusiness.3008":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "kcode.error.providerBusiness.3009":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "kcode.error.providerBusiness.3010":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "kcode.error.providerBusiness.3102":
    "This run exceeded the maximum single-run time. Create a new off-peak task to continue.",
  "kcode.error.modelSuspiciousEmpty":
    "The model returned no content (often caused by an expired token or plan issues). Please send again.",
  "kcode.error.providerBusiness.2007":
    "The upstream service is temporarily unavailable. Please try again later.",
  "kcode.error.providerBusiness.429":
    "You're sending requests too quickly. Please try again later.",
  ...
  "resourceManager.appUsage": "KCode",
  ...
  "feedback.submit.template.section.copyErrorHeading": "KCode Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while KCode is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task KCode can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "KCode Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "KCode Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart KCode",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart KCode to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified KCode plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "KCode will verify the Computer Use tools against the exact session when your first session starts.",
