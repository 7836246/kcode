...
const enUS: Record<string, string> = {
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to KCode 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by KCode automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in KCode.",
  ...
  "sidebar.usage.plan.mcp": "KCode MCP",
  "sidebar.usage.plan.kcodeMcp": "KCode MCP",
  "sidebar.usage.plan.kcodeMcpDescription": "Daily aggregate quota for KCode built-in plugin MCPs",
