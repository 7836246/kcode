...
const zhCN: Record<string, string> = {
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 KCode 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 KCode 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 KCode 使用团队额度。",
  ...
  "sidebar.usage.plan.kcodeMcpDescription": "KCode 预置插件 MCP 每日合计额度",
