...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 KCode 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 KCode 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 KCode 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 KCode",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 KCode。",
  ...
  "startup.global.starting_services": "正在启动 KCode",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 KCode。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 KCode 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 KCode",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 KCode 后重试",
  ...
  "quickPick.command.feedback": "在 GitHub 报告问题",
  ...
  "bots.title": "机器人",
  "bots.description": "把外部聊天工具和 Webhook 接入 KCode 机器人。",
  "bots.listTitle": "机器人",
  "bots.addBot": "新建机器人",
  ...
  "bots.setup.guide.weixin.create.2":
    "KCode 会直接保存 iLink 返回的 bot_token；扫码后请在微信里向 Bot 发送任意消息完成会话激活。",
  "bots.setup.guide.weixin.create.3":
    "KCode 内置 iLink 客户端，通过 `/ilink/bot/getupdates` 长轮询收消息，通过 `/ilink/bot/sendmessage` 回复。",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook 模式不需要先在第三方平台创建原生机器人；你的系统只需要能向 KCode 回调接口发消息。",
  ...
  "bots.setup.guide.webhook.bind.1": "向 KCode 的 `/api/bots/webhook` 发送一条私聊消息回调。",
  ...
  "bots.setup.guide.webhook.bind.3":
    "如果配置了 secret，请同时在请求头里带上 `x-kcode-bot-secret`；绑定成功后再回到这里完成设置。",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere": "Telegram 长轮询由另一个 KCode 窗口处理。",
  ...
  "login.title": "欢迎来到 KCode",
  "login.description": "选择供应商并填入 API Key，测通后进入工作区",
  ...
  "login.apiKey.testing": "正在测试连接",
  "login.apiKey.emptyError": "请输入 API key。",
  "login.apiKey.error.auth": "API Key 无效或没有权限。请核对 Key。",
  "login.apiKey.error.endpoint": "连不上接口地址。请检查网络或代理，或换一个供应商。",
  "login.apiKey.error.model": "供应商有响应，但默认模型不可用。可以先跳过，到设置里改模型名。",
  "login.apiKey.error.other": "连接失败：{reason}",
  "login.apiKey.error.unknown": "连接失败",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 KCode？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 KCode Agent 会落盘 model-io）",
  ...
  "workspaceHeader.help.issueReport": "在 GitHub 报告问题",
  ...
  "titleBar.menu.help.about": "关于 KCode",
  "titleBar.menu.help.checkForUpdates": "检查更新",
  "titleBar.menu.help.feedback": "在 GitHub 报告问题",
  ...
  "titleBar.menu.help.toggleKCodeStdioTap": "抓取 Agent stdio 通信",
  ...
  "forceUpdate.title": "需要升级 KCode 后继续使用",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 KCode 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 KCode CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "remote.trigger": "远程连接",
  "remote.wizard": "远程连接",
  "remoteConnection.feedback": "在 GitHub 报告问题",
  ...
  "taskList.feedback": "在 GitHub 报告问题",
  "taskList.viewModelTrajectory": "查看调用轨迹",
  "taskList.feedbackOpened": "已打开 GitHub Issues",
  "taskList.resume": "恢复",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 KCode 终端的字体覆盖。",
  ...
  "settings.managedSystemRole.editorHint":
    "这里编辑的是 ~/.kcode/system-role.md。预览显示当前草稿；保存后新对话才会用上。正文过长只在框内滚动。",
  "settings.managedSystemRole.preset.label": "预设",
  "settings.managedSystemRole.preset.default": "默认",
  "settings.managedSystemRole.preset.unrestricted": "破限",
  "settings.managedSystemRole.preset.add": "添加预设",
  "settings.managedSystemRole.preset.saveNew": "保存为预设",
  "settings.managedSystemRole.preset.namePlaceholder": "预设名称",
  "settings.managedSystemRole.preset.delete": "删除预设",
  "settings.managedSystemRole.preset.added": "已添加预设。点保存后新对话才会用上当前正文。",
  "settings.managedSystemRole.preset.addFailed": "添加预设失败。",
  "settings.managedSystemRole.preset.deleteFailed": "删除预设失败。",
  "settings.managedSystemRole.preset.update": "更新预设",
  ...
  "settings.kcodeInteractionBehavior": "交互行为",
  "settings.kcodeInteractionBehaviorDescription":
    "在 KCode 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  "settings.kcodeInteractionBehavior.option.queue": "队列",
  "settings.kcodeInteractionBehavior.option.guide": "引导",
  ...
  "settings.dataBaseDirDescription":
    "应用数据的根目录（默认为用户主目录），修改后会将现有数据复制到新位置。路径后缀 .kcode/v2 不可更改。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 KCode 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 KCode 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "KCode 总占用",
  ...
  "resourceManager.storage.diskUsage": "KCode 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 KCode 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "KCode 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 KCode。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。KCode 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.description": "管理 KCode Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 KCode 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 KCode Agent 不支持 OAuth 状态刷新。请升级或重启 KCode，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 KCode。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 KCode",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。KCode 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。KCode 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.modelProvider.fetchModels": "获取模型列表",
  "settings.modelProvider.fetchingModels": "正在获取模型列表",
  "settings.modelProvider.fetchModelsListed": "远端共 {count} 个模型，请选择要添加的项",
  "settings.modelProvider.fetchModelsDialogTitle": "选择要添加的模型",
  "settings.modelProvider.fetchModelsDialogDescription":
    "远端共 {total} 个模型，其中 {added} 个已在当前列表。新模型默认不勾选。",
  "settings.modelProvider.fetchModelsSearchPlaceholder": "搜索模型 ID",
  "settings.modelProvider.fetchModelsSearchEmpty": "没有匹配的模型",
  "settings.modelProvider.fetchModelsSelectedCount": "已选 {count} 个新模型",
  "settings.modelProvider.fetchModelsSelectVisible": "全选当前结果",
  "settings.modelProvider.fetchModelsDeselectVisible": "取消当前结果",
  "settings.modelProvider.fetchModelsAlreadyAdded": "已添加",
  "settings.modelProvider.fetchModelsConfirm": "添加 {count} 个模型",
  "settings.modelProvider.fetchModelsSuccess": "已添加 {added} 个模型",
  "settings.modelProvider.fetchModelsEmpty": "没有新的模型可添加",
  "settings.modelProvider.fetchModelsFailure": "获取模型列表失败：{error}",
  "settings.modelProvider.clearModels": "清空",
  "settings.modelProvider.clearModelsConfirmTitle": "清空当前模型列表？",
  "settings.modelProvider.clearModelsConfirmDescription":
    "将移除这个供应商下的全部模型。Base URL 和 API Key 会保留。",
  "settings.modelProvider.clearModelsConfirmAction": "清空",
  "settings.modelProvider.clearModelsSuccess": "已清空模型列表",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 KCode 即可继续编码。",
  ...
  "settings.modelProvider.testModel.error.auth": "API Key 无效或没有权限",
  "settings.modelProvider.testModel.error.endpoint": "连不上接口地址",
  "settings.modelProvider.testModel.error.model_not_found": "模型名不存在或当前账号不可用",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 KCode。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。KCode 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 KCode",
  ...
  "settings.subagents.description": "管理 KCode Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 KCode 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 KCode，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。KCode 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 KCode",
  ...
  "settings.commands.description":
    "管理 KCode Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 KCode。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。KCode 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 KCode",
  ...
  "settings.workspaceFileSearch.description":
    "编辑 .kcodeignore 忽略规则（语法与 .gitignore 一致），控制工作区文件搜索的范围。保存后下次搜索生效。",
  "settings.workspaceFileSearch.templateHint":
    ".kcodeignore 尚未创建：下方为初始内容预览（.gitignore 拷贝 + 默认排除规则），保存后才会写入工作区。",
  ...
  "settings.workspaceFileSearch.revealHint": "保存后即可在工作区根目录找到 .kcodeignore",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 KCode 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 KCode",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 KCode",
  "onboarding.welcome.start": "开始使用 KCode",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 KCode 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，KCode 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 KCode 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 KCode 提问…",
  ...
  "chat.stop": "停止生成",
  "chat.stop.short": "停止",
  // 输入框「提示词增强」入口；设置分区文案见 settings.promptEnhance.*
  "chat.toolbar.promptEnhance.label": "增强提示词",
  "chat.toolbar.promptEnhance.running": "增强中 {seconds}s",
  "chat.toolbar.promptEnhance.startTooltip": "用模型改写这条草稿并放回输入框，不会自动发送",
  "chat.toolbar.promptEnhance.cancelTooltip": "再次点击可取消本次增强",
  "chat.toolbar.promptEnhance.restoreLabel": "还原",
  "chat.toolbar.promptEnhance.restoreTooltip": "退回增强前的原文",
  ...
  "chat.toolbar.promptEnhance.emptyResult": "模型没有返回内容，草稿保持原样",
  "chat.toolbar.promptEnhance.fillFailed": "写入输入框失败，草稿保持不变",
  "chat.toolbar.promptEnhance.draftChanged": "草稿在增强期间已被修改，本次结果未回填",
  "chat.toolbar.promptEnhance.failed": "提示词增强失败：{error}",
  "chat.toolbar.promptEnhance.restored": "已还原为增强前的原文",
  "chat.toolbar.promptEnhance.restoreRejected": "草稿已被手动修改，无法还原",
  "chat.toolbar.promptEnhance.restoreFailed": "还原未写入，草稿保持不变，可再试一次",
  ...
  "chat.modelFallback.switched": "已改用 {model}",
  "settings.modelFallback.title": "备用模型",
  "settings.modelFallback.description":
    "当前模型超时、限流或服务端错误时，按这个顺序继续同一回合。密钥错误和内容拒绝不会更换。",
  "settings.modelFallback.empty": "还没有备用模型",
  "settings.modelFallback.add": "添加备用模型",
  "settings.modelFallback.remove": "移除",
  "settings.modelFallback.moveUp": "上移",
  "settings.modelFallback.moveDown": "下移",
  ...
  "settings.promptEnhance.channel.providerPlaceholder": "选择 Provider",
  "settings.promptEnhance.channel.model": "模型",
  "settings.promptEnhance.channel.modelPlaceholder": "选择模型",
  "settings.promptEnhance.reasoning.label": "推理强度",
  "settings.promptEnhance.reasoning.note": "仅对独立通道生效",
  "settings.promptEnhance.reasoning.default": "默认",
  "settings.promptEnhance.reasoning.low": "低",
  ...
  "settings.promptEnhance.prompt.hide": "收起",
  "settings.promptEnhance.reset": "恢复默认",
  "settings.promptEnhance.saveError": "设置没有保存",
  "chat.preparing": "准备中...",
  ...
  "chat.toolbar.mode.approvalTitle": "应如何批准 KCode 操作?",
  // CUA 输入框常驻入口按钮
  ...
  "workflows.hub.empty.hint":
    "在对话里让 KCode 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 KCode 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 KCode 修订后另存一版。",
  ...
  "chat.error.feedback": "在 GitHub 报告问题",
  "chat.error.feedbackOpened": "已打开 GitHub Issues",
  "chat.error.noAvailableModel": "当前没有可用模型。请先配置供应商和模型。",
  ...
  "chat.quota.mcp.quotaExhausted": "KCode MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 KCode MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  // 模式
  "mode.plan": "计划",
  "mode.label.glm.build": "请求批准",
  "mode.label.glm.edit": "帮我批准",
  "mode.label.glm.plan": "计划模式",
  "mode.label.glm.yolo": "完全访问权限",
  "mode.description.glm.build": "编辑外部文件和使用互联网时始终询问",
  "mode.description.glm.edit": "仅对检测到的风险操作请求批准",
  "mode.description.glm.plan": "编辑前先出计划。",
  "mode.description.glm.yolo": "可不受限制地访问互联网和电脑上的任何文件",
  "todo.panel.title": "待办",
  ...
  // KCode Agent
  "kcode.unavailable": "AI 代理不可用",
  "kcode.initFailed": "启动 AI 代理失败",
  "kcode.error.TASK_OWNED_BY_OTHER_HOST": "该任务正在另一个已连接视图中运行。",
  "kcode.error.STALE_TASK_OWNER_COMMAND": "该操作属于旧的运行轮次，已忽略。",
  "kcode.error.NO_ACTIVE_TASK_OWNER": "当前没有可处理该操作的任务所有者。",
  "kcode.error.OWNER_COMMAND_FAILED": "任务所有者未能完成该操作。",
  ...
  "kcode.error.providerBusiness.1006": "登录状态已失效，请重新登录后再试。",
  "kcode.error.providerBusiness.1005":
    "今日免费计划额度已用完。请升级账户、切换模型，或等待额度恢复。",
  "kcode.error.providerBusiness.3006": "当前模型不在可用范围内，请切换到允许的模型后重试。",
  "kcode.error.providerBusiness.3002": "请求过于频繁，请稍后重试。",
  "kcode.error.providerBusiness.3001": "请求参数错误，请检查输入后重试。",
  "kcode.error.providerBusiness.3007": "请求被网关安全校验拒绝，请稍后重试或联系支持。",
  "kcode.error.providerBusiness.3008": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "kcode.error.providerBusiness.3009": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "kcode.error.providerBusiness.3010": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "kcode.error.providerBusiness.3102": "已超过单次最长运行时间，请创建新的闲时任务继续。",
  "kcode.error.modelSuspiciousEmpty": "模型未返回任何内容。",
  "kcode.error.providerBusiness.2007": "上游服务暂时不可用，请稍后重试。",
  "kcode.error.providerBusiness.429": "请求过于频繁，请稍后重试。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "KCode 报错信息",
  ...
  "offPeak.keepAwakeBanner": "KCode 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 KCode 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "KCode 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "KCode 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 KCode",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 KCode 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 KCode 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，KCode 会针对该会话精确验证电脑控制工具。",
