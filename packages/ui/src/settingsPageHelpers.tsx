...
export type { Locale, LocalePreference } from "@kcode/shared";
...
const KCODE_INTERACTION_BEHAVIOR_OPTIONS: readonly KCodeInteractionBehavior[] = ["queue", "guide"];
...
export function GeneralSectionContent({
  ...
  onKCodeInteractionBehaviorChange,
  ...
  onKCodeInteractionBehaviorChange: (behavior: KCodeInteractionBehavior) => Promise<void>;
  ...
  return (
    <div className="space-y-4">
      ...
      <SettingsGroupCard>
        <SettingsRow
          label={intl.formatMessage({ id: "settings.kcodeInteractionBehavior" })}
          description={intl.formatMessage({
            id: "settings.kcodeInteractionBehaviorDescription",
          })}
          control={
            <Select
              value={kcodeInteractionBehavior}
              onValueChange={(value) => {
                void onKCodeInteractionBehaviorChange(value as KCodeInteractionBehavior);
              }}
            >
              <SelectTrigger size="lg" className="w-[260px] min-w-0 justify-between">
                <SelectValue />
              ...
              <SelectContent>
                {KCODE_INTERACTION_BEHAVIOR_OPTIONS.map((behavior) => (
                  <SelectItem key={behavior} value={behavior}>
                    {intl.formatMessage({
                      id: `settings.kcodeInteractionBehavior.option.${behavior}`,
                    })}
                  </SelectItem>
                ))}
              </SelectContent>
