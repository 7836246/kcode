const TASK_NOTIFICATION_ENABLED_STORAGE_KEY = "kcode-notification-enabled";
const TASK_NOTIFICATION_SOUND_ENABLED_STORAGE_KEY = "kcode-notification-sound-enabled";
