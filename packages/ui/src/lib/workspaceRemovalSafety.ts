import type { FileEntry, KCodeTaskMeta, KCodeTaskRuntimeStatus } from "@kcode/shared";
import type { IFileService } from "@kcode/services";
...
export function hasRunningWorkspaceChat(params: {
  workspaceState: Pick<WorkspaceKCodeUIState, "draftRuntime" | "taskRuntimeByTaskId">;
  taskItems: Pick<KCodeTaskMeta, "taskId">[];
}): boolean {
...
function isWorkspaceRemovalBlockingRuntimeStatus(status: KCodeTaskRuntimeStatus): boolean {
