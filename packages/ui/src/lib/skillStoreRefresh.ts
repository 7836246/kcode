...
export async function refreshSharedSkillStoreForWorkspace(params: {
  ...
  const normalizedProvider = normalizeAgentProviderToKCodeAgent(
    params.provider ?? KCODE_AGENT_PROVIDER,
  );
  ...
  if (
    ...
    normalizeAgentProviderToKCodeAgent(skillStore.provider) === normalizedProvider &&
