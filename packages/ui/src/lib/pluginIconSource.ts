...
const OFFICIAL_PLUGIN_ICON_BY_ID: Readonly<Record<string, string>> = {
  "documents@kcode-plugins-official": documentsIconUrl,
  "image-search@kcode-plugins-official": imageSearchIconUrl,
  "pdf@kcode-plugins-official": pdfIconUrl,
  "plugin-creator@kcode-plugins-official": pluginCreatorIconUrl,
  "presentations@kcode-plugins-official": presentationsIconUrl,
  "spreadsheets@kcode-plugins-official": spreadsheetsIconUrl,
};
