...
function hasOwnTaskMetaField<T extends keyof KCodeTaskMeta>(task: KCodeTaskMeta, key: T) {
...
function resolveMergedTaskTitle(preferredTask: KCodeTaskMeta, fallbackTask: KCodeTaskMeta): string {
...
export function mergeTaskMetaCandidates(
  ...candidates: Array<KCodeTaskMeta | null | undefined>
): KCodeTaskMeta | undefined {
  let merged: KCodeTaskMeta | undefined;
