...
import { isCronTask, isOffPeakTask, type KCodeTaskMeta } from "@kcode/shared";
import { TID_TASK_ARCHIVE, TID_TASK_ITEM, testId } from "@kcode/shared";
...
function getTaskAutomationIdentity(task: KCodeTaskMeta): string | undefined {
  return task.cronAutomationId ?? (task as KCodeTaskMeta & { automationId?: string }).automationId;
}

function areTaskListItemTaskFieldsEqual(left: KCodeTaskMeta, right: KCodeTaskMeta) {
  if (left === right) {
    return true;
  }
