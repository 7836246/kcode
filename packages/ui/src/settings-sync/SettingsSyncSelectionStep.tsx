...
import type { SettingsSyncCategory, SettingsSyncDiscoveryResult } from "@kcode/shared";
...
function formatAgentName(agent: string, intl: ReturnType<typeof useKCodeIntl>["intl"]): string {
  switch (agent) {
    case "kcode":
      return intl.formatMessage({ id: "settingsSync.agent.kcode" });
    case "claudeCode":
