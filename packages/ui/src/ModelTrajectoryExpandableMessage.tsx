...
function compactTextPreview(message: KCodeModelTrajectoryMessage): string {
...
function firstLinePreview(message: KCodeModelTrajectoryMessage): string {
...
function messageClipboardText(message: KCodeModelTrajectoryMessage): string {
