...
import type { ApplicationIconRequest } from "@kcode/shared";
import { useKCodeIntl } from "@/i18n/IntlProvider.js";
import { isKCodeCuaToolName } from "@/lib/cuaPermissionAction.js";
...
function readCuaToolName(value: string | null | undefined): string | null {
  ...
  //   main namesp: mcp__plugin_kcode_cua_computer_use__<action>
...
export function isCuaToolCall(
  ...
  return collectToolNames(toolCall).some(isKCodeCuaToolName);
}
...
type CuaIntl = ReturnType<typeof useKCodeIntl>["intl"];
