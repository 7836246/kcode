 ...
 *
 * 一行的读法与模型面
 * （apps/kcode-cli/packages/core/src/tool/handlers/get-workflow-run-format-roster.ts）同一句话：
...
import type { ToolCallGetWorkflowRunDisplay } from "@kcode/shared/kcode-protocol-v4";
...
type FormatMessage = ReturnType<typeof useKCodeIntl>["intl"]["formatMessage"];
