...
import { TID_CRON_CREATE_CARD, TID_CRON_CREATE_OPEN } from "@kcode/shared";
import type { KCodeAutomationScheduleRule } from "@kcode/shared";
...
function isScheduleRule(value: unknown): value is KCodeAutomationScheduleRule {
...
function readCronCreateAutomationOutputSummary(value: unknown): CronCreateAutomationSummary | null {
  ...
  const scheduleRule = isScheduleRule(automation.scheduleRule)
    ? (automation.scheduleRule as KCodeAutomationScheduleRule)
    : undefined;
