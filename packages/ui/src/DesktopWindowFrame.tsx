  ...
  return (
    <div
      className={cn(
        ...
        // 外壳 20px 与内层 16px 面板及 4px inset 构成同心圆。Linux 合成器在原生拖拽/缩放时
        // 可能短暂丢失 overflow 圆角，额外使用同半径 clip-path 固定合成裁切；最大化时两者一起归零。
        isLinuxDesktop &&
          "rounded-[20px] [clip-path:inset(0_round_20px)] platform-linux-window-maximized:rounded-none platform-linux-window-maximized:[clip-path:inset(0)]",
