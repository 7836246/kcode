...
import type { WorkspaceKCodeUIState } from "@/store/kcodeSessionStore.js";
...
export interface WorkspaceShellKCodeState {
  activeTaskId: WorkspaceKCodeUIState["activeTaskId"];
  draftFocusVersion: WorkspaceKCodeUIState["draftFocusVersion"];
  modelSwitchPending: WorkspaceKCodeUIState["modelSwitchPending"];
  modelSwitchStage: WorkspaceKCodeUIState["modelSwitchStage"];
  selectedProvider: WorkspaceKCodeUIState["selectedProvider"];
  optimisticTaskListByTaskId: WorkspaceKCodeUIState["optimisticTaskListByTaskId"];
  workspaceInit: WorkspaceKCodeUIState["workspaceInit"];
...
export type CreateTaskRequest = KCodeProvider | CreateTaskOptions;
...
export interface WorkspaceShellLayoutProps extends AppProps {
  ...
  workspaceTabs: Array<{
    ...
    remoteTarget?: import("@kcode/shared").RemoteTarget;
    workspaceIdentity?: string;
