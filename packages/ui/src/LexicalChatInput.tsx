...
function E2ELexicalInputBridgePlugin({ inputTestId }: { inputTestId?: string }) {
  ...
  useEffect(() => {
    ...
    const detachBridge = (input: HTMLElement | null) => {
      if (
        input &&
        (input as { __kcodeLexicalInputE2E?: typeof bridge }).__kcodeLexicalInputE2E === bridge
      ) {
        delete (input as { __kcodeLexicalInputE2E?: typeof bridge }).__kcodeLexicalInputE2E;
      }
    ...
    const attachBridge = (input: HTMLElement | null) => {
      ...
      Object.defineProperty(input, "__kcodeLexicalInputE2E", {
        configurable: true,
        value: bridge,
      });
