...
export const KCODE_MODE_OPTION_LABEL_IDS: Record<KCodeProvider, Record<string, string>> = {
  glm: {
...
export const KCODE_MODE_OPTION_DESCRIPTION_IDS: Record<KCodeProvider, Record<string, string>> = {
  glm: {
