...
export interface TestActions extends TaskListE2EActions {
  ...
  /** E2E 通过真实 kcodeAgentService 拉取插件 overview */
  getPluginsOverview: IKCodeAgentService["getPluginsOverview"];
  /** E2E 通过真实 kcodeAgentService 添加 marketplace */
  addPluginMarketplace: IKCodeAgentService["addPluginMarketplace"];
  /** E2E 通过真实 kcodeAgentService 刷新 marketplace */
  updatePluginMarketplace: IKCodeAgentService["updatePluginMarketplace"];
  /** E2E 通过真实 kcodeAgentService 安装 marketplace plugin */
  installPlugin: IKCodeAgentService["installPlugin"];
  /** E2E 通过真实 kcodeAgentService 触发插件 discover */
  listPlugins: IKCodeAgentService["listPlugins"];
  /** E2E 通过真实 kcodeAgentService 查询 Workspace/Session Plugin catalog */
  getPluginReferenceCatalog: IKCodeAgentService["getPluginReferenceCatalog"];
}
