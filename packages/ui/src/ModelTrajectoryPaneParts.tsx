...
export type IntlShape = ReturnType<typeof useKCodeIntl>["intl"];
...
export function CallCard({
  ...
  record: KCodeModelTrajectoryRecord;
  index: number;
  inputMessages: KCodeModelTrajectoryMessage[];
...
function SourceTitle({ record, intl }: { record: KCodeModelTrajectoryRecord; intl: IntlShape }) {
  const callSource: NonNullable<KCodeModelTrajectoryRecord["callSource"]> = record.callSource ?? {
    kind: "main",
  };
...
function sourceLabelId(callSource: NonNullable<KCodeModelTrajectoryRecord["callSource"]>): string {
...
function MessageBlock({
  ...
  message: KCodeModelTrajectoryMessage;
...
function ResponseBlock({
  ...
  response: NonNullable<KCodeModelTrajectoryRecord["response"]>;
  callStartedAt: string;
  callDurationMs?: number;
