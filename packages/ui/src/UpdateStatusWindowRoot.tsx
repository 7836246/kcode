import type { IPlatformService, Locale, UpdateStatePayload } from "@kcode/shared";
import { useCallback, useEffect, useRef, useState } from "react";
import { KCodeIntlProvider } from "@/i18n/IntlProvider.js";
...
export function UpdateStatusWindowRoot({
  ...
  return (
    <div className="min-h-screen bg-transparent text-foreground">
      ...
      <KCodeIntlProvider key={locale} initialLocale={locale}>
