 ...
 *
 * 路径解析与文件读取都收口在 kcodeTaskService.getModelTrajectory（host 侧），
...
export function useModelTrajectory(
  ...
  }, [kcodeTaskService, taskId, workspaceIdentity, workspacePath, reloadToken]);
