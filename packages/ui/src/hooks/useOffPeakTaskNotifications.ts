...
import type { KCodeOffPeakTaskStatus } from "@kcode/shared";
import type { IOffPeakTaskService } from "@kcode/services";
...
function notifiableStatus(status: KCodeOffPeakTaskStatus): "completed" | "failed" | null {
