import type { KCodeTaskGroupColor } from "@kcode/services";
...
const TASK_GROUP_COLOR_CLASS: Record<KCodeTaskGroupColor, string> = {
...
const TASK_GROUP_BORDER_COLOR_CLASS: Record<KCodeTaskGroupColor, string> = {
