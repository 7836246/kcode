...
import type { V4ConversationFileRewindPreviewResult } from "@kcode/shared/kcode-protocol-v4";
...
function formatReason(reason: string, intl: ReturnType<typeof useKCodeIntl>["intl"]) {
