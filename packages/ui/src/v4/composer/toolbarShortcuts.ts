...
import type { ShortcutCommandId, KCodeConfigOption } from "@kcode/shared";
import {
...
function getChatToolbarShortcutKey(
  category: KCodeConfigOption["category"],
...
interface ToolbarShortcutState {
  ...
  modelOption?: KCodeConfigOption;
  modeOption?: KCodeConfigOption;
  thoughtOption?: KCodeConfigOption;
}
