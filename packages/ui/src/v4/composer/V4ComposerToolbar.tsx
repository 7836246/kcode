...
import { useToolbarConfigOptions } from "@/hooks/useKCodeConfig.js";
...
function V4ComposerModelControlsImpl({
  ...
  const modelOption = modelSelectionView?.providers.some((candidate) => candidate.models.length > 0)
    ? ({
        id: "model",
        name: "Model",
        category: "model",
  ...
  const thoughtOption = useMemo<KCodeConfigOption | null>(() => {
