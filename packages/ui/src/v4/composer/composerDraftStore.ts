...
//
// 旧草稿面（kcodeSessionStore composerDraftByScopeId + chatComposerDraftStorage 写路径）
...
import { modelSelectionSchema, type ModelSelection } from "@kcode/shared";
...
const STORAGE_KEY_PREFIX = "kcode-v4-composer-drafts:v1:";
