...
import type { ISkillsService } from "@kcode/services";
...
interface SkillStoreState {
  ...
  initialize: (
    ...
    providerOrSkillsService: KCodeProvider | ISkillsService,
  ...
  setEnabled: (
    skillId: string,
    providerOrEnabled: KCodeProvider | boolean,
...
export const useSkillStore = create<SkillStoreState>((set, get) => ({
  ...
  async initialize(
    ...
    const provider = normalizeAgentProviderToKCodeAgent(
      hasProvider ? providerOrSkillsService : KCODE_AGENT_PROVIDER,
    );
