...
export const HELPER_ADDON_ENV = "KCODE_CUA_HELPER_ADDON";
export const WINDOWS_DEV_CONTROL_PROTOCOL = "kcode-cua-windows-dev/v1";
...
export function isPotentialKCodeCuaAgentMcpServer(_server) {
  return false;
}
