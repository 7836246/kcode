...
export const BROKER_SOCKET_ENV = "KCODE_CUA_PERMISSION_BROKER_SOCKET";
export const BROKER_UNAVAILABLE_ENV = "KCODE_CUA_PERMISSION_BROKER_UNAVAILABLE";
...
export function mintBrokerSocketPath(options = {}) {
  ...
  return join(dir, `kcode-cua-broker-${randomUUID()}.sock`);
}
