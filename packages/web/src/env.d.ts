declare module "*.css";
declare module "@kcode/ui/styles.css";
...
interface ImportMetaEnv {
  ...
  readonly VITE_KCODE_BASE_URL?: string;
  readonly VITE_KCODE_ENDPOINT_ORIGIN?: string;
  readonly VITE_KCODE_WEB_REMOTE_CONTROL_RELAY_WS_URL?: string;
}
