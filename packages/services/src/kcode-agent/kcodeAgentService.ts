import { requestPluginReferenceCatalog } from "#src/kcode-agent/pluginReferenceCatalogRequest.js";
import {
  localTtftFactsSchema,
  sessionDebugSnapshotSchema,
  type LocalTtftFacts,
} from "@kcode/shared";
/* oxlint-disable eslint(max-lines) -- KCode Protocol transport、通知 wiring 和 app-facing session 方法必须共享同一个 client/emitter 上下文。 */
...
import {
  ...
  KCODE_AGENT_PROVIDER_NOT_READY_CODE,
  KCODE_AGENT_PROVIDER_NOT_READY_REASON,
  KCODE_MODEL_REASONING_SEPARATOR,
  isRemoteWorkspaceIdentity,
  KCODE_PROTOCOL_NAME,
  KCODE_PROTOCOL_VERSION,
  kcodeMcpListResultSchema,
  kcodePermissionRequestParamsSchema,
  kcodeBrowserListParamsSchema,
  kcodeBrowserExecuteParamsSchema,
  kcodePluginsConfigureResultSchema,
  kcodePluginsInstallResultSchema,
  kcodePluginsListResultSchema,
  kcodePluginsMarketplaceMutationResultSchema,
  kcodePluginsOverviewResultSchema,
  kcodeProcessChildProcessesResultSchema,
  type KCodeProcessChildProcess,
  kcodeSkillsReferenceCatalogResultSchema,
  kcodeWorkflowsDeleteResultSchema,
  kcodeWorkflowsGetResultSchema,
  kcodeWorkflowsListResultSchema,
  kcodeWorkflowsMoveResultSchema,
  kcodeWorkflowsRunsResultSchema,
  kcodeWorkflowsUpdateMetaResultSchema,
  kcodePluginsResolveSuggestedReferenceResultSchema,
  kcodePluginOperationProgressNotificationSchema,
  kcodePluginsRestoreBuiltinResultSchema,
  kcodePluginsSetEnabledResultSchema,
  kcodePluginsCancelOperationResultSchema,
  kcodePluginsUninstallResultSchema,
  kcodePluginsValidateResultSchema,
  kcodePluginsDescribeResultSchema,
  kcodeAutomationCheckTaskBindingParamsSchema,
  kcodeAutomationCreateParamsSchema,
  kcodeAutomationDeleteParamsSchema,
  kcodeAutomationListParamsSchema,
  kcodeAutomationUpdateParamsSchema,
  kcodeOffPeakCreateParamsSchema,
  kcodeOffPeakListParamsSchema,
  OFF_PEAK_PROVIDER_IDS,
  kcodeComputerUseOperationEventSchema,
  kcodeProviderRuntimeHeadersCancelledSchema,
  kcodeProviderRuntimeHeadersRequestParamsSchema,
  kcodeProviderTestModelConnectivityResultSchema,
  kcodeOfficialMcpAuthHeadersRequestParamsSchema,
  summarizeOfficialMcpIdentityHeaders,
  kcodeProtocolEmptyResultSchema,
  kcodeProtocolMethods,
  kcodeProtocolNotifications,
  kcodeMcpTelemetryEventSchema,
  kcodeMcpResourceSamplesSchema,
  kcodeToolExecResourceSchema,
  kcodeProcessResourceSampleSchema,
  kcodeSessionCloseResultSchema,
  kcodeSessionCompactResultSchema,
  kcodeSessionEventsResultSchema,
  kcodeSessionGoalResultSchema,
  kcodeSessionListResultSchema,
  kcodeSessionSubagentsResultSchema,
  kcodeSessionMessagesResultSchema,
  kcodeSessionEventSchema,
  kcodeSessionSendResultSchema,
  kcodeSessionRequestRuntimePreferencesParamsSchema,
  kcodeSessionRuntimePreferencesResultSchema,
  kcodeSessionStateSnapshotSchema,
  kcodeSessionSubscribeResultSchema,
  kcodeStateUpdatedNotificationSchema,
  kcodeUserInputRequestParamsSchema,
  kcodeWorkspacePresentationSchema,
  kcodeWorkspaceCancelGenerateTextResultSchema,
  kcodeWorkspaceGenerateTextResultSchema,
  kcodeWorkspaceHookTrustGrantResultSchema,
  kcodeWorkspaceUpdateInteractionPreferencesResultSchema,
  kcodeWorkspaceUpdateModelIoPreferencesResultSchema,
  kcodeProviderUpdateAccountConfigResultSchema,
  type KCodeSessionStateSnapshot,
  type KCodeAutomation,
  type KCodeAutomationRun,
  kcodeWorkspaceUpdateOffPeakToolPolicyResultSchema,
  kcodeWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
  ...
  type KCodeToolExecResource,
  type KCodePluginOperationProgressNotification,
  type KCodeTaskMode,
} from "@kcode/shared";
...
} from "#src/kcode-agent/automationToolPolicy.js";
import { KCODE_AGENT_RUNTIME_UNAVAILABLE_CODE } from "./kcodeAgent.js";
import type {
  KCodeProtocolRequestId,
  ModelSelection,
  KCodeProviderRuntimeHeadersRequestParams,
  KCodeSessionEvent,
  KCodeSessionRuntimePreferencesScope,
  KCodeSavedWorkflowScope,
  KCodeStateUpdatedNotification,
  KCodeWorkspacePresentation,
  KCodeWorkspaceRef,
  KCodeSessionRuntimePreferencesResult,
} from "@kcode/shared";
import type {
  IKCodeAgentService,
  KCodeAgentBackgroundBashOutputParams,
  KCodeAgentAppRuntimePreferences,
  KCodeAgentRuntimeLifecycleEvent,
  KCodeAgentAddPluginMarketplaceParams,
  KCodeAgentAppUsageParams,
  KCodeAgentCancelPluginOperationParams,
  KCodeAgentCompactParams,
  ...
  KCodeAgentListSessionsParams,
  KCodeAgentListSessionSubagentsParams,
  KCodeAgentReadWorkspacePresentationParams,
  KCodeAgentReadSessionEventsParams,
  KCodeAgentReadSessionMessagesParams,
  KCodeAgentReadSessionParams,
  KCodeAgentRemovePluginMarketplaceParams,
  KCodeAgentRespondSessionRuntimePreferencesParams,
  ...
  KCodeAgentSessionRuntimePreferencesRequest,
  KCodeAgentTaskTokenUsageParams,
  ...
  KCodeAgentSkillReferenceCatalogParams,
  KCodeAgentDeleteSavedWorkflowParams,
  KCodeAgentGetSavedWorkflowParams,
  KCodeAgentListSavedWorkflowRunsParams,
  KCodeAgentListSavedWorkflowsParams,
  KCodeAgentMoveSavedWorkflowParams,
  KCodeAgentSavedWorkflowTarget,
  KCodeAgentUpdateSavedWorkflowMetaParams,
  ...
  KCodeAgentListMcpServerStatusesParams,
  KCodeAgentWorkspaceTarget,
  KCodeAgentCuaPermissionObservation,
  KCodeAgentCreateAutomationParams,
  KCodeAgentUpdateAutomationParams,
  KCodeAgentAutomationIdParams,
  KCodeAgentSetAutomationEnabledParams,
  KCodeAgentDeleteAutomationRunParams,
  KCodeAgentAttachmentBeginParams,
  KCodeAgentAttachmentChunkParams,
  KCodeAgentAttachmentReadParams,
  KCodeAgentConversationAttachmentReadParams,
  KCodeAgentConversationAttachmentStatParams,
  KCodeAgentAttachmentPreviewSourceParams,
  KCodeAgentAttachmentTerminalParams,
  KCodeAgentConversationCommandParams,
  KCodeAgentCommandsQueryParams,
  KCodeAgentConversationFileChangesParams,
  KCodeAgentConversationFileRewindPreviewParams,
  KCodeAgentConversationRowsRangeParams,
  KCodeAgentConversationPlansParams,
  KCodeAgentConversationWorkflowRunEventsParams,
  KCodeAgentConversationWorkflowRunArtifactDataParams,
  KCodeAgentConversationWorkflowRunArtifactReadParams,
  KCodeAgentConversationWorkflowRunArtifactsParams,
  KCodeAgentConversationWorkflowRunNodeResultParams,
  KCodeAgentConversationWorkflowRunWorkspaceParams,
  KCodeAgentConversationWorkflowRunsParams,
  KCodeAgentConversationResyncParams,
  KCodeAgentConversationSubscribeParams,
  KCodeAgentConversationUnsubscribeParams,
  KCodeAgentConnectionFlowParams,
  KCodeAgentSessionsIndexSubscribeParams,
  KCodeAgentWorkspaceConfigSubscribeParams,
} from "./kcodeAgent.js";
import {
  ...
  utf8JsonByteLength,
  KCODE_ATTACHMENT_FAULT_CODES,
  KCodeAttachmentFaultError,
  type CommandAck,
...
import {
  ...
  readTrustedKCodeAgentV4UnsubscribeRoute,
  type KCodeAgentV4ConnectionContext,
} from "./kcodeAgentConnectionScope.js";
import { createBackgroundSessionEventCoalescer } from "#src/kcode-agent/kcodeSessionEventCoalescer.js";
...
import { KCodeAgentMcpStatusModeUnsupportedError } from "#src/kcode-agent/kcodeAgentErrors.js";
import { KCodeAgentProcessManager } from "./kcodeAgentProcessManager.js";
import type { KCodeAgentProcessManagerOptions } from "./kcodeAgentProcessManager.js";
import type { IOffPeakTaskService } from "#src/session/offPeakTask.js";
import {
  KCodeProtocolRequestTimeoutError,
  type KCodeProtocolClient,
} from "./kcodeProtocolClient.js";
import { getDataBaseDir } from "../paths.js";
import {
  collectBrowserAmbientContext,
  type BrowserAmbientContextExecutor,
} from "./kcodeAgentBrowserAmbientContext.js";
import {
...
const logger = createServiceLogger("kcode-agent-service");
...
interface PendingPermissionRequest {
  client: KCodeProtocolClient;
  protocolRequestId: KCodeProtocolRequestId;
}

interface PendingProviderRuntimeHeadersRequest extends PendingPermissionRequest {
  request: KCodeProviderRuntimeHeadersRequestParams;
  responding?: boolean;
}

interface PendingSessionRuntimePreferencesRequest extends PendingPermissionRequest {
  request: KCodeAgentSessionRuntimePreferencesRequest;
...
function isClosedStdioTransportError(error: unknown): boolean {
  return error instanceof Error && error.message === "KCode agent stdio transport is closed";
}
...
function buildWorkspaceRef(params: KCodeAgentWorkspaceTarget): KCodeWorkspaceRef {
  return {
...
function savedWorkflowTargetHasWorkspace(
  params: KCodeAgentSavedWorkflowTarget,
): params is KCodeAgentWorkspaceTarget & { scope?: KCodeSavedWorkflowScope } {
  return typeof (params as Partial<KCodeAgentWorkspaceTarget>).workspacePath === "string";
}

// 只在 `scope` 有定义时下推到 RPC params：不给 scope 的项目档保持与今天逐字一致的线上形状。
function savedWorkflowScopeParam(params: KCodeAgentSavedWorkflowTarget): {
  scope?: KCodeSavedWorkflowScope;
} {
  return params.scope === undefined ? {} : { scope: params.scope };
}

function ensurePluginManagementWorkspacePath(): string {
  const workspacePath = join(getDataBaseDir(), ".kcode", PLUGIN_MANAGEMENT_WORKSPACE_DIR_NAME);
...
// NOTE: this counts ONLY the per-session MCP servers passed through the KCode Protocol
// session/create params (the app→protocol channel). It is deliberately independent of the
// CLI/bootstrap MCP servers configured in ~/.kcode/cli/config.json (mcp.servers), which the agent
// runtime connects separately and reports via the `mcp.server.connected`/toolCount events. So a
// createSession log line with mcpServerCount:0 is EXPECTED when kcode-cua is a CLI-config MCP server
...
// real kimi-k2.6 turns call mcp__kcode-cua__* tools (get_app_state/type/open_application, status
...
function isProtocolRequestTimeout(error: unknown, method: string): boolean {
  if (error instanceof KCodeProtocolRequestTimeoutError) {
    return error.method === method;
  }
  return error instanceof Error && error.message === `KCode Protocol request timed out: ${method}`;
}
...
function buildSessionCreateParams(
  params: KCodeAgentCreateSessionParams & {
...
function buildSessionResumeParams(
  params: KCodeAgentResumeSessionParams & {
    offPeakToolEnabled?: boolean;
    dynamicWorkflowEnabled?: boolean;
  },
...
function buildSessionSendParams(
  params: KCodeAgentSendPromptParams,
...
function buildSessionCompactParams(params: KCodeAgentCompactParams) {
  return {
    sessionId: params.sessionId,
    inputId: params.inputId,
...
function sessionEventKey(params: KCodeAgentSessionTarget): string {
...
function permissionRequestKey(params: KCodeAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function userInputRequestKey(params: KCodeAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function providerRuntimeHeadersRequestKey(
  params: KCodeAgentSessionTarget & { requestId: string },
): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}
...
interface KCodeAgentProviderReadinessSnapshot {
...
): KCodeAgentProviderReadinessSnapshot {
...
interface WaitingWorkspaceStartup {
  ...
  workspace: KCodeAgentWorkspaceTarget;
}
...
function createRuntimeUnavailableError(params: KCodeAgentWorkspaceTarget): Error & {
  code: typeof KCODE_AGENT_RUNTIME_UNAVAILABLE_CODE;
  workspaceKey: string;
} {
  const error = new Error("KCode Agent runtime is not running.") as Error & {
    code: typeof KCODE_AGENT_RUNTIME_UNAVAILABLE_CODE;
    workspaceKey: string;
  };
  error.code = KCODE_AGENT_RUNTIME_UNAVAILABLE_CODE;
  error.workspaceKey = resolveWorkspaceKey(params);
  return error;
}

interface CreateKCodeAgentServiceOptions extends Omit<
  KCodeAgentProcessManagerOptions,
  "idleTimeoutMs"
> {
...
function toProtocolAutomation(automation: KCodeAutomation) {
  return {
...
async function respondOffPeakInternalError(
  client: Pick<KCodeProtocolClient, "respondError">,
  request: { id: KCodeProtocolRequestId; method: string },
  workspace: KCodeAgentWorkspaceTarget,
  error: unknown,
): Promise<void> {
...
export function createKCodeAgentService(
  options?: CreateKCodeAgentServiceOptions,
): IKCodeAgentService & { disposeAllAndWait(): Promise<void> } {
  const processManager = new KCodeAgentProcessManager(options);
  ...
  const pluginProcessManager = new KCodeAgentProcessManager({
  ...
  const mcpStatusProcessManager = new KCodeAgentProcessManager({
    commandResolver: options?.commandResolver,
    presentationSurface: options?.presentationSurface,
  ...
  const sessionEmitters = new Map<string, Emitter<KCodeAgentServiceEvent>>();
  /**
  ...
  const sessionRuntimePreferencesRequestEmitter =
    new Emitter<KCodeAgentSessionRuntimePreferencesRequest>();
  const processResourceSampleEmitter = new Emitter<AgentLaneResourceSample>();
  const toolExecResourceEmitter = new Emitter<KCodeToolExecResource>();
  const mcpResourceSamplesEmitter = new Emitter<KCodeMcpResourceSample[]>();
  const mcpTelemetryEmitter = new Emitter<KCodeMcpTelemetryEvent>();
  const pluginOperationProgressEmitters = new Map<
    string,
    Emitter<KCodePluginOperationProgressNotification>
  >();
  ...
  const cuaPermissionObservationEmitter = new Emitter<KCodeAgentCuaPermissionObservation>();
  ...
  const wiredClients = new WeakSet<KCodeProtocolClient>();
  const clientDisposables = new WeakMap<KCodeProtocolClient, IDisposable[]>();
  ...
  let latestAppRuntimePreferences: KCodeAgentAppRuntimePreferences | undefined;
  ...
  const accountConfigSyncByClient = new WeakMap<KCodeProtocolClient, Promise<void>>();
  // 此缓存只去重已交付的账号快照，不表示 Worker 的 Registry 已应用该版本。
  const accountConfigReceivedRevisionByClient = new WeakMap<KCodeProtocolClient, string>();
  ...
  function invalidateWorkspaceClient(workspaceKey: string, client: KCodeProtocolClient): void {
  ...
  async function respondAccountRequestAuthWithoutInteraction(params: {
    ...
    try {
      ...
      logger.info(undefined, "KCode provider runtime headers 已应用", {
      ...
      if (pendingProviderRuntimeHeaders.get(params.key) !== params.pending) return;
      logger.warn(undefined, "KCode provider runtime headers 应用失败", {
        modelId: params.pending.request.modelSelection.modelId,
        providerId: params.pending.request.providerId,
        requestId: params.pending.request.requestId,
        sessionId: params.pending.request.sessionId,
  ...
  function expireSessionRuntimePreferencesRequest(requestId: string): void {
    ...
    logger.warn(undefined, "运行时偏好请求等待 Host 响应超时", {
      event: "kcode_agent.runtime_preferences.host_response_timeout",
      module: "services.kcode_agent",
      requestId,
      scope: pending.request.scope,
      sessionId: pending.request.sessionId,
      timeoutMs: KCODE_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
    ...
    const current = previous
      ...
      .then(async () => {
        ...
        const result = await params.client.request(
          kcodeProtocolMethods.providerUpdateAccountConfig,
          {
        ...
        logger.info(undefined, "account provider config 已交付到 KCode agent", {
  ...
  function enqueueInteractionPreferenceSync(params: {
    client: KCodeProtocolClient;
    preferences: KCodeAgentAppRuntimePreferences;
    workspace: KCodeAgentWorkspaceTarget;
  }): Promise<void> {
    ...
    const current = previous
      ...
      .then(async () => {
        await params.client.request(
          kcodeProtocolMethods.workspaceUpdateInteractionPreferences,
          {
        ...
        try {
          await params.client.request(
            kcodeProtocolMethods.workspaceUpdateModelIoPreferences,
            {
              workspace: buildWorkspaceRef(params.workspace),
              preferences: {
  ...
  async function handleProviderReadinessChanged(event: {
    reason: string;
    snapshot: KCodeAgentProviderReadinessSnapshot;
  }): Promise<void> {
    if (event.snapshot.readiness.ready) {
      await Promise.allSettled(
        Array.from(waitingWorkspaceStartups.entries()).map(async ([workspaceKey, waiting]) => {
          ...
          logger.info(undefined, "provider/model 就绪后已启动等待中的 KCode agent", {
  ...
  function getSessionEmitter(params: KCodeAgentSessionTarget) {
    const key = sessionEventKey(params);
    const existing = sessionEmitters.get(key);
    if (existing) {
      return existing;
    }
    const created = new Emitter<KCodeAgentServiceEvent>();
  ...
  function getPluginOperationProgressEmitter(operationId: string) {
    ...
    let created: Emitter<KCodePluginOperationProgressNotification>;
    created = new Emitter({
  ...
  function getConversationFrameEmitter(workspace: KCodeAgentWorkspaceTarget) {
  ...
  function getConversationTelemetryFactEmitter(workspace: KCodeAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getSessionsIndexFrameEmitter(workspace: KCodeAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getWorkspaceConfigFrameEmitter(workspace: KCodeAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function resolveV4Connection(
    ...
    return (
      readTrustedKCodeAgentV4Connection(params) ?? {
  ...
  function resolveV4UnsubscribeRoute(
    params: KCodeAgentConversationUnsubscribeParams | KCodeAgentConversationResyncParams,
    topicPrefix: string,
  ): V4SubscriptionRoute | null {
    const expectedWorkspaceKey = resolveWorkspaceKey(params);
    const trusted = readTrustedKCodeAgentV4UnsubscribeRoute(params);
    if (trusted) {
  ...
  async function unsubscribeV4Route(
    params: KCodeAgentConversationUnsubscribeParams,
    topicPrefix: string,
  ): Promise<void> {
  ...
  async function resyncV4Route(params: KCodeAgentConversationResyncParams, topicPrefix: string) {
    const route = resolveV4UnsubscribeRoute(params, topicPrefix);
  ...
  function handleStateUpdated(
    workspace: KCodeAgentWorkspaceTarget,
    notification: KCodeStateUpdatedNotification,
  ): void {
  ...
  function wireClient(
    ...
    const disposables = [
      client.onNotification((message) => {
        if (message.method === kcodeProtocolNotifications.providerRuntimeHeadersCancelled) {
          const parsed = kcodeProviderRuntimeHeadersCancelledSchema.safeParse(message.params);
          if (
            !parsed.success ||
        ...
        if (message.method === kcodeProtocolNotifications.processResourceSample) {
          const parsed = kcodeProcessResourceSampleSchema.safeParse(message.params);
          if (parsed.success) {
            processResourceSampleEmitter.fire({ ...parsed.data, lane });
          } else {
            logger.debug(undefined, "丢弃无效 KCode CLI 资源样本", {
        ...
        if (message.method === kcodeProtocolNotifications.toolExecResource) {
          const parsed = kcodeToolExecResourceSchema.safeParse(message.params);
          if (parsed.success) toolExecResourceEmitter.fire(parsed.data);
          return;
        }
        if (message.method === kcodeProtocolNotifications.mcpResourceSamples) {
          const parsed = kcodeMcpResourceSamplesSchema.safeParse(message.params);
          if (parsed.success) mcpResourceSamplesEmitter.fire(parsed.data);
          else logger.debug(undefined, "丢弃无效 MCP 资源样本");
          return;
        }

        if (message.method === kcodeProtocolNotifications.mcpTelemetry) {
          const parsed = kcodeMcpTelemetryEventSchema.safeParse(message.params);
          if (parsed.success) {
            mcpTelemetryEmitter.fire(parsed.data);
          } else {
            logger.debug(undefined, "丢弃无效 KCode CLI MCP 遥测事件", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                path: issue.path.join("."),
              })),
        ...
        if (message.method === kcodeProtocolNotifications.pluginOperationProgress) {
          const parsed = kcodePluginOperationProgressNotificationSchema.safeParse(message.params);
          if (parsed.success) {
            pluginOperationProgressEmitters.get(parsed.data.operationId)?.fire(parsed.data);
          } else {
            logger.warn(undefined, "丢弃无效 KCode Protocol 插件操作进度", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
        ...
        if (message.method === kcodeProtocolMethods.computerUseOperationEvent) {
          const parsed = kcodeComputerUseOperationEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(undefined, "丢弃无效 KCode Protocol Computer Use operation event", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                message: issue.message,
                path: issue.path.join("."),
        ...
        if (message.method === "session/event") {
          const parsed = kcodeSessionEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(
              ...
              "丢弃无效 KCode Protocol session event",
              {
        ...
        if (message.method === "state.updated") {
          const parsed = kcodeStateUpdatedNotificationSchema.safeParse(message.params);
          if (parsed.success) {
      ...
      client.onRequest((request) => {
        if (request.method === kcodeProtocolMethods.sessionRequestRuntimePreferences) {
          ...
          const parsed = kcodeSessionRequestRuntimePreferencesParamsSchema.safeParse(
            request.params,
          );
          if (!parsed.success) {
            void client
          ...
          if (sessionRuntimePreferencesAuthority === "local") {
            void (async () => {
              let preferences: KCodeSessionRuntimePreferencesResult;
              try {
                preferences = kcodeSessionRuntimePreferencesResultSchema.parse(
          ...
          const dynamicRequest: KCodeAgentSessionRuntimePreferencesRequest = {
            ...parsed.data,
            requestId,
          };
          ...
          logger.info(undefined, "运行时偏好请求已转发给 Host", {
            event: "kcode_agent.runtime_preferences.host_request_dispatched",
            module: "services.kcode_agent",
            requestId,
        ...
        if (request.method === kcodeProtocolMethods.interactionRequestPermission) {
          const parsed = kcodePermissionRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
        ...
        if (request.method === kcodeProtocolMethods.interactionRequestUserInput) {
          const parsed = kcodeUserInputRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === kcodeProtocolMethods.interactionRequestProviderRuntimeHeaders) {
          const parsed = kcodeProviderRuntimeHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
          ...
          logger.info(request.trace?.traceId, "收到 KCode provider runtime headers 请求", {
        ...
        if (request.method === kcodeProtocolMethods.interactionRequestOfficialMcpAuthHeaders) {
          const parsed = kcodeOfficialMcpAuthHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === kcodeProtocolMethods.interactionBrowserList) {
          const parsed = kcodeBrowserListParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === kcodeProtocolMethods.interactionBrowserExecute) {
          const parsed = kcodeBrowserExecuteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === kcodeProtocolMethods.automationCreate) {
          const parsed = kcodeAutomationCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === kcodeProtocolMethods.offPeakCreate) {
          const parsed = kcodeOffPeakCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === kcodeProtocolMethods.offPeakList) {
          const parsed = kcodeOffPeakListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === kcodeProtocolMethods.automationList) {
          const parsed = kcodeAutomationListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === kcodeProtocolMethods.automationCheckTaskBinding) {
          const parsed = kcodeAutomationCheckTaskBindingParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === kcodeProtocolMethods.automationUpdate) {
          const parsed = kcodeAutomationUpdateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === kcodeProtocolMethods.automationDelete) {
          const parsed = kcodeAutomationDeleteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        void client.respondError(request.id, {
          code: -32601,
          message: `Unsupported KCode Protocol request: ${request.method}`,
        });
      }),
      client.onClose(() => {
  ...
  function rememberSessionTrace(
    target: KCodeAgentSessionTarget,
  ...
  function getSessionTraceId(target: KCodeAgentSessionTarget): TraceId | undefined {
  ...
  function createProviderNotReadyError(params: {
    ...
    code: typeof KCODE_AGENT_PROVIDER_NOT_READY_CODE;
    data: {
      providerCount: number;
      reason: typeof KCODE_AGENT_PROVIDER_NOT_READY_REASON;
    ...
    error.code = KCODE_AGENT_PROVIDER_NOT_READY_CODE;
    error.data = {
      providerCount: params.snapshot?.providerCount ?? 0,
      reason: KCODE_AGENT_PROVIDER_NOT_READY_REASON,
  ...
  function isProviderNotReadyError(
    error: unknown,
  ): error is Error & { code: typeof KCODE_AGENT_PROVIDER_NOT_READY_CODE } {
    return (
      error instanceof Error &&
      (error as { code?: unknown }).code === KCODE_AGENT_PROVIDER_NOT_READY_CODE
    );
  }

  async function resolveStartupReadiness(): Promise<
    KCodeAgentProviderReadinessSnapshot | undefined
  > {
  ...
  function isReusableActiveClientEntry(
    params: KCodeAgentWorkspaceTarget,
    ...
    activeClientsByWorkspaceKey.delete(workspaceKey);
    interactionPreferenceSyncByWorkspaceKey.delete(workspaceKey);
    logger.warn(undefined, "复用的 KCode Protocol client 已 disposed，清理 stale entry", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return false;
  ...
  async function getOrStartReadOnlyClient(
    ...
    const interactionPreferencesReady = (async () => {
      let appliedSnapshot: KCodeAgentAppRuntimePreferences | undefined;
    ...
    const offPeakToolPolicyReady = (async () => {
      ...
      try {
        await client.request(
          kcodeProtocolMethods.workspaceUpdateOffPeakToolPolicy,
    ...
    const dynamicWorkflowPolicyReady = (async () => {
      ...
      try {
        await client.request(
          kcodeProtocolMethods.workspaceUpdateDynamicWorkflowPolicy,
          { workspace: buildWorkspaceRef(params), enabled: true },
          kcodeWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
        );
      } catch (error) {
    ...
    logger.info(undefined, "为只读会话控制面启动 KCode agent", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return entry;
  ...
  async function getClient(params: KCodeAgentWorkspaceTarget) {
    const workspaceKey = resolveWorkspaceKey(params);
    const active = activeClientsByWorkspaceKey.get(workspaceKey);
    ...
    if (!readinessSnapshot || !readiness?.ready) {
      ...
      if (waiting.lastLoggedRevision !== revision) {
        ...
        logger.info(
          undefined,
          active
            ? "provider/model 尚未就绪，KCode agent 保持只读"
            : "provider/model 尚未就绪，KCode agent 保持未启动",
          {
    ...
    waitingWorkspaceStartups.delete(workspaceKey);
    logger.info(undefined, "provider/model 就绪，允许 KCode agent 模型执行", {
  ...
  async function getPluginManagementClient(): Promise<KCodeProtocolClient> {
  ...
  // homedir() 即用户家目录，全局根 `~/.kcode/workflows/` 因此解析到真实目录。
  // 远程 runtime（SSH/WSL identity 或带 remoteSessionId）的 home 不是本机，绝不选它当载体。
  function isLocalActiveWorkspaceClient(workspace: KCodeAgentWorkspaceTarget): boolean {
    return (
      !workspace.remoteSessionId &&
      !(workspace.workspaceIdentity && isRemoteWorkspaceIdentity(workspace.workspaceIdentity))
    );
  ...
  async function resolveSavedWorkflowCarrier(
    params: KCodeAgentSavedWorkflowTarget,
  ): Promise<{ client: KCodeProtocolClient; workspace: KCodeWorkspaceRef }> {
  ...
  async function getMcpStatusClient(): Promise<KCodeProtocolClient> {
    const workspace = { workspacePath: ensurePluginManagementWorkspacePath() };
  ...
  async function buildConversationCommandEnvelope(
    params: KCodeAgentConversationCommandParams,
  ...
  return {
    ...
    async initialize(params: KCodeAgentWorkspaceTarget): Promise<KCodeAgentInitializeResult> {
      const workspaceKey = resolveWorkspaceKey(params);
      const startedAt = Date.now();
      logger.info(undefined, "开始初始化 KCode agent", {
        workspaceKey,
        workspacePath: params.workspacePath,
      });
      try {
        const client = await getClient(params);
        logger.info(undefined, "KCode agent 初始化完成", {
        ...
        return {
          available: true,
          workspaceKey,
          protocolName: KCODE_PROTOCOL_NAME,
          protocolVersion: KCODE_PROTOCOL_VERSION,
          transportKind: client.transportKind === "websocket" ? "websocket" : "stdio",
        };
      } catch (error) {
        ...
        logger[providerNotReady ? "info" : "warn"](
          undefined,
          providerNotReady ? "KCode agent 等待 provider/model 就绪" : "KCode agent 初始化失败",
          {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            workspaceKey,
        ...
        return {
          ...
          ...(providerNotReady ? { reasonCode: KCODE_AGENT_PROVIDER_NOT_READY_REASON } : {}),
        };
      }
    },

    async syncAppRuntimePreferences(preferences: KCodeAgentAppRuntimePreferences): Promise<void> {
      const normalizedPreferences: KCodeAgentAppRuntimePreferences = {
        ...preferences,
    ...
    async getWorkspaceRuntimeIdentity(params: KCodeAgentWorkspaceTarget) {
    ...
    async createSession(params: KCodeAgentCreateSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      logger.info(sessionTraceId, "开始请求 KCode Protocol session/create", {
      ...
      try {
        const snapshot = await client.request(
          kcodeProtocolMethods.sessionCreate,
        ...
        logger.info(sessionTraceId, "KCode Protocol session/create 完成", {
          durationMs: Date.now() - startedAt,
        ...
        if (compatFields.length === 0) {
          logger.warn(sessionTraceId, "KCode Protocol session/create 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            persistence: params.persistence,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId, "KCode Protocol session/create 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
        ...
        if (!compatFields.includes("thoughtLevel") || !params.thoughtLevel) {
          logger.info(sessionTraceId, "KCode Protocol session/create 兼容重试完成", {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
            snapshotTraceId: snapshot.session.traceId ?? null,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        const snapshotWithThoughtLevel = await client.request(
          kcodeProtocolMethods.sessionSetThoughtLevel,
          {
            sessionId: snapshot.session.sessionId,
            thoughtLevel: params.thoughtLevel,
        ...
        logger.info(
          sessionTraceId,
          "KCode Protocol session/create 兼容重试后设置 thoughtLevel 完成",
          {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
    ...
    async resumeSession(params: KCodeAgentResumeSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      const dynamicWorkflowEnabled = await resolveDynamicWorkflowGate();
      logger.info(cachedTraceId, "开始请求 KCode Protocol session/resume", {
        mcpServerCount: getMcpServerCount(params),
        mcpServerNames: getMcpServerNames(params),
      ...
      try {
        const snapshot = await client.request(
          kcodeProtocolMethods.sessionResume,
        ...
        logger.info(sessionTraceId, "KCode Protocol session/resume 完成", {
          durationMs: Date.now() - startedAt,
          messageCount: snapshot.messages.length,
          modelCurrent: formatModelSelectionForLog(snapshot.settings.model.current),
          mcpServerCount: getMcpServerCount(params),
        ...
        if (compatFields.length === 0) {
          logger.warn(cachedTraceId, "KCode Protocol session/resume 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(cachedTraceId, "KCode Protocol session/resume 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        const sessionTraceId = rememberSessionTrace(params, snapshot) ?? cachedTraceId;
        logger.info(sessionTraceId, "KCode Protocol session/resume 兼容重试完成", {
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          snapshotTraceId: snapshot.session.traceId ?? null,
          workspaceKey: resolveWorkspaceKey(params),
    ...
    async listSessions(params: KCodeAgentListSessionsParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const result = await client.request(
        kcodeProtocolMethods.sessionList,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async listSessionSubagents(params: KCodeAgentListSessionSubagentsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        kcodeProtocolMethods.sessionSubagents,
        {
          sessionId: params.sessionId,
    ...
    async getAppUsageStats(params: KCodeAgentAppUsageParams) {
    ...
    async getTaskTokenUsage(params: KCodeAgentTaskTokenUsageParams) {
      const client = await getReadOnlyClient(params);
    ...
    async readSession(params: KCodeAgentReadSessionParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      ...
      const snapshot = await client.request(
        kcodeProtocolMethods.sessionRead,
        {
          sessionId: params.sessionId,
    ...
    async readSessionMessages(params: KCodeAgentReadSessionMessagesParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        kcodeProtocolMethods.sessionMessages,
        {
          sessionId: params.sessionId,
    ...
    async readSessionDebug(params) {
      ...
      return client.request(
        kcodeProtocolMethods.sessionDebug,
        { sessionId: params.sessionId },
        sessionDebugSnapshotSchema,
      );
    },

    async readSessionEvents(params: KCodeAgentReadSessionEventsParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        kcodeProtocolMethods.sessionEvents,
        {
          sessionId: params.sessionId,
          afterSeq: params.afterSeq,
          limit: params.limit,
    ...
    async readWorkspacePresentation(params: KCodeAgentReadWorkspacePresentationParams) {
      const startedAt = Date.now();
      logger.info(undefined, "开始请求 KCode Protocol workspace/readPresentation", {
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      });
      try {
        let presentation: KCodeWorkspacePresentation | undefined;
        for (let attempt = 0; attempt < 2; attempt += 1) {
          ...
          try {
            ...
            presentation = await client.request(
              kcodeProtocolMethods.workspaceReadPresentation,
              { workspace: buildWorkspaceRef(params) },
              kcodeWorkspacePresentationSchema,
            );
            break;
        ...
        if (!presentation) {
          throw new Error("KCode Protocol workspace/readPresentation did not return a result");
        }
        logger.info(undefined, "KCode Protocol workspace/readPresentation 完成", {
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(undefined, "KCode Protocol workspace/readPresentation 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
    ...
    async grantWorkspaceHookTrust(params: KCodeAgentGrantWorkspaceHookTrustParams) {
    ...
    async listMcpServerStatuses(params: KCodeAgentListMcpServerStatusesParams) {
      ...
      try {
        ...
        if (params.mode === "status" && unrecognizedKeys.includes("mode")) {
          ...
          throw new KCodeAgentMcpStatusModeUnsupportedError();
        }
        if (
        ...
        if (!isProtocolRequestTimeout(error, kcodeProtocolMethods.mcpList)) {
          throw error;
        }
    ...
    async listPlugins(params: KCodeAgentPluginViewParams) {
      const requestPluginsList = async () => {
        ...
        return client.request(
          kcodeProtocolMethods.pluginsList,
          {
            workspace: buildWorkspaceRef(params),
      ...
      try {
        ...
        if (!isProtocolRequestTimeout(error, kcodeProtocolMethods.pluginsList)) {
          throw error;
        }
    ...
    async getPluginReferenceCatalog(params: KCodeAgentPluginReferenceCatalogParams) {
    ...
    async getSkillReferenceCatalog(params: KCodeAgentSkillReferenceCatalogParams) {
      // 与 Plugin 引用一样，Session 快照只存在于 workspace agent 进程；独立管理进程
      // 没有 resident Session，不能作为对话 authority。
      const client = await getReadOnlyClient(params);
      return client.request(
        kcodeProtocolMethods.skillsReferenceCatalog,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.sessionId ? { sessionId: params.sessionId } : {}),
        },
    ...
    // `scope` 只在有定义时下推。
    async listSavedWorkflows(params: KCodeAgentListSavedWorkflowsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        kcodeProtocolMethods.workflowsList,
        { workspace, ...savedWorkflowScopeParam(params) },
        kcodeWorkflowsListResultSchema,
      );
    },

    async getSavedWorkflow(params: KCodeAgentGetSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        kcodeProtocolMethods.workflowsGet,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        kcodeWorkflowsGetResultSchema,
      );
    },

    async updateSavedWorkflowMeta(params: KCodeAgentUpdateSavedWorkflowMetaParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        kcodeProtocolMethods.workflowsUpdateMeta,
        { workspace, name: params.name, meta: params.meta, ...savedWorkflowScopeParam(params) },
        kcodeWorkflowsUpdateMetaResultSchema,
      );
    },

    async deleteSavedWorkflow(params: KCodeAgentDeleteSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        kcodeProtocolMethods.workflowsDelete,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        kcodeWorkflowsDeleteResultSchema,
      );
    },

    async listSavedWorkflowRuns(params: KCodeAgentListSavedWorkflowRunsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        kcodeProtocolMethods.workflowsRuns,
        {
          workspace,
    ...
    async moveSavedWorkflow(params: KCodeAgentMoveSavedWorkflowParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        kcodeProtocolMethods.workflowsMove,
        { workspace: buildWorkspaceRef(params), name: params.name },
        kcodeWorkflowsMoveResultSchema,
      );
    },

    async resolveSuggestedPluginReference(params: KCodeAgentResolveSuggestedPluginReferenceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsResolveSuggestedReference,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async collectLocalRuntimeChildProcesses(signal?: AbortSignal) {
      ...
      return Promise.all(
        managed.map(async (runtime) => {
          let children: KCodeProcessChildProcess[] = [];
          try {
            const result = await runtime.client.request(
              kcodeProtocolMethods.processChildProcesses,
              {},
              kcodeProcessChildProcessesResultSchema,
    ...
    async getPluginsOverview(params: KCodeAgentPluginViewParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsOverview,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.configScope ? { configScope: params.configScope } : {}),
        },
    ...
    async addPluginMarketplace(params: KCodeAgentAddPluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsMarketplaceAdd,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async removePluginMarketplace(params: KCodeAgentRemovePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsMarketplaceRemove,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePluginMarketplace(params: KCodeAgentUpdatePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsMarketplaceUpdate,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async installPlugin(params: KCodeAgentInstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsInstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async cancelPluginOperation(params: KCodeAgentCancelPluginOperationParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsCancelOperation,
        { operationId: params.operationId },
        kcodePluginsCancelOperationResultSchema,
    ...
    async uninstallPlugin(params: KCodeAgentUninstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsUninstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePlugin(params: KCodeAgentUpdatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsUpdate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginId ? { pluginId: params.pluginId } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async restoreBuiltinPlugin(params: KCodeAgentRestoreBuiltinPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsRestoreBuiltin,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async configurePlugin(params: KCodeAgentConfigurePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsConfigure,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async resetPluginConfig(params: KCodeAgentResetPluginConfigParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsResetConfig,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
          ...(params.scope ? { scope: params.scope } : {}),
    ...
    async validatePlugin(params: KCodeAgentValidatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsValidate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginName ? { pluginName: params.pluginName } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async describePlugin(params: KCodeAgentDescribePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsDescribe,
        {
          workspace: buildWorkspaceRef(params),
          marketplace: params.marketplace,
          pluginName: params.pluginName,
    ...
    async setPluginEnabled(params: KCodeAgentSetPluginEnabledParams) {
      const client = await getPluginManagementClient();
      return client.request(
        kcodeProtocolMethods.pluginsSetEnabled,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async listAutomations(params: KCodeAgentWorkspaceTarget) {
    ...
    async createAutomation(params: KCodeAgentCreateAutomationParams) {
      return automationService.create({
        ...
        mode: params.mode as KCodeTaskMode | undefined,
        workspacePath: params.workspacePath,
        workspaceIdentity: params.workspaceIdentity,
    ...
    async updateAutomation(params: KCodeAgentUpdateAutomationParams) {
      return automationService.update(
        params.automationId,
        {
          ...
          prompt: params.prompt,
          modelSelection: params.modelSelection,
          mode: params.mode === null ? null : (params.mode as KCodeTaskMode | undefined),
    ...
    async deleteAutomation(params: KCodeAgentAutomationIdParams) {
    ...
    async setAutomationEnabled(params: KCodeAgentSetAutomationEnabledParams) {
    ...
    async restartAutomation(params: KCodeAgentAutomationIdParams) {
    ...
    async runAutomationNow(params: KCodeAgentAutomationIdParams) {
    ...
    async listAutomationRuns(params: KCodeAgentAutomationIdParams) {
    ...
    async deleteAutomationRun(params: KCodeAgentDeleteAutomationRunParams) {
    ...
    async generateWorkspaceText(params: KCodeAgentGenerateWorkspaceTextParams) {
      const client = await getClient(params);
      // Worker 自己读取 KCode Built-in / Personal Config；Host 只在执行前确保账号状态形成的
      ...
      try {
        return await client.request(
          kcodeProtocolMethods.workspaceGenerateText,
          {
            workspace: buildWorkspaceRef(params),
    ...
    async testModelConnectivity(params: KCodeAgentTestModelConnectivityParams) {
      ...
      return client.request(
        kcodeProtocolMethods.providerTestModelConnectivity,
        {
          workspace: buildWorkspaceRef(params),
          selection: params.selection,
        },
    ...
    async sendPrompt(params: KCodeAgentSendPromptParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      ...
      const protocolParams: KCodeAgentSendPromptParams = {
        ...params,
        ...(browserAmbientContext ? { browserAmbientContext } : {}),
      };
      logger.info(logTraceId, "KCode Agent session/send 开始", {
      ...
      try {
        const result = await client.request(
          kcodeProtocolMethods.sessionSend,
          buildSessionSendParams(protocolParams),
          kcodeSessionSendResultSchema,
        );
        logger.info(logTraceId, "KCode Agent session/send ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          queryId: params.queryId ?? null,
          sessionId: params.sessionId,
        ...
        if (compatFields.length > 0) {
          logger.warn(logTraceId, "KCode Agent session/send 命中新旧协议兼容重试", {
            compatFields,
            durationMs: Date.now() - startedAt,
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(logTraceId, "KCode Agent session/send 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          queryId: params.queryId ?? null,
    ...
    async compactSession(params: KCodeAgentCompactParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      const sessionTraceId = getSessionTraceId(params);
      logger.info(sessionTraceId ?? params.inputId, "KCode Protocol session/compact 开始", {
        inputId: params.inputId,
        sessionId: params.sessionId,
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      ...
      try {
        const result = await client.request(
          kcodeProtocolMethods.sessionCompact,
        ...
        logger.info(sessionTraceId ?? params.inputId, "KCode Protocol session/compact ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId ?? params.inputId, "KCode Protocol session/compact 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          sessionId: params.sessionId,
    ...
    async goalSession(params: KCodeAgentGoalParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(params.inputId, "开始请求 KCode Protocol session/goal", {
      ...
      try {
        const result = await client.request(
          kcodeProtocolMethods.sessionGoal,
          {
            sessionId: params.sessionId,
            inputId: params.inputId,
            action: params.action,
        ...
        logger.info(params.inputId, "KCode Protocol session/goal 完成", {
          action: params.action,
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(params.inputId, "KCode Protocol session/goal 失败", {
          action: params.action,
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          sessionId: params.sessionId,
    ...
    async closeSession(
      params: KCodeAgentSessionTarget & {
        expectedPersistence?: "deferred" | "immediate";
      },
    ): Promise<boolean> {
      const client = await getClient(params);
      const result = await client.request(
        kcodeProtocolMethods.sessionClose,
        {
          sessionId: params.sessionId,
    ...
    async setModel(params: KCodeAgentSetModelParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(undefined, "开始请求 KCode Protocol session/setModel", {
      ...
      try {
        const snapshot = await client.request(
          kcodeProtocolMethods.sessionSetModel,
          {
            sessionId: params.sessionId,
            model: params.model,
            expectedRevision: params.expectedRevision,
        ...
        logger.info(undefined, "KCode Protocol session/setModel 完成", {
          durationMs: Date.now() - startedAt,
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
        ...
        logger.warn(undefined, "KCode Protocol session/setModel 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
    ...
    async setThoughtLevel(params: KCodeAgentSetThoughtLevelParams) {
      const client = await getClient(params);
      const snapshot = await client.request(
        kcodeProtocolMethods.sessionSetThoughtLevel,
        {
    ...
    async setMode(params: KCodeAgentSetModeParams) {
      const client = await getClient(params);
      return client.request(
        kcodeProtocolMethods.sessionSetMode,
        {
          sessionId: params.sessionId,
          mode: params.mode,
          expectedRevision: params.expectedRevision,
    ...
    async respondSessionRuntimePreferences(
      params: KCodeAgentRespondSessionRuntimePreferencesParams,
    ): Promise<void> {
      const pending = takePendingSessionRuntimePreferences(params.requestId);
      if (!pending) {
        logger.warn(undefined, "运行时偏好响应找不到 pending 请求", {
          event: "kcode_agent.runtime_preferences.response_without_pending",
          module: "services.kcode_agent",
          requestId: params.requestId,
        });
        throw new Error(`KCode session runtime preferences request not found: ${params.requestId}`);
      }
      const responseContext = {
        event: "kcode_agent.runtime_preferences.host_response_received",
        module: "services.kcode_agent",
        requestId: params.requestId,
        scope: pending.request.scope,
        sessionId: pending.request.sessionId,
    ...
    onDynamicSessionEvent(params: KCodeAgentSessionSubscribeParams) {
      ...
      return (listener) => {
        ...
        const pendingLiveEvents: KCodeAgentServiceEvent[] = [];
        ...
        const deliverToListener = (event: KCodeAgentServiceEvent): void => {
          if (cancelled) {
            return;
          }
        ...
        const establishSubscription = async (attempt: number): Promise<void> => {
          ...
          try {
            ...
            const result = await client.request(
              kcodeProtocolMethods.sessionSubscribe,
              {
                sessionId: params.sessionId,
                deliveryKind: params.deliveryKind,
                afterSeq: params.afterSeq,
            ...
            if (attempt >= SESSION_SUBSCRIBE_MAX_ATTEMPTS - 1) {
              ...
              console.warn(
                formatLogPrefix("kcode-agent", process.pid),
    ...
    async setConnectionFlowStateV4(params: KCodeAgentConnectionFlowParams) {
      const trusted = readTrustedKCodeAgentV4Connection(params);
    ...
    async subscribeConversationV4(params: KCodeAgentConversationSubscribeParams) {
      ...
      // Account Config 顺序屏障，不提升模型执行权限。KCode Built-in / Personal 仍由 Worker 维护。
    ...
    async unsubscribeConversationV4(params: KCodeAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "conversation/");
    },

    async resyncConversationV4(params: KCodeAgentConversationResyncParams) {
      return resyncV4Route(params, "conversation/");
    },

    async sendConversationCommandV4(params: KCodeAgentConversationCommandParams) {
      const client = await getClient(params);
      ...
      const commandClientMode =
        readTrustedKCodeAgentV4Connection(params)?.clientMode ??
        params.clientMode ??
        "desktop-continuous";
      if (params.envelope.type === "createSession") {
        // V4 草稿预热直接走 command 转发；新会话创建前只需等待 Account Config，
        // KCode Built-in / Personal 已由 Worker 进程 Registry 自己装配。
        await ensureAccountProviderConfigSynced({
          client,
    ...
    async queryConversationCommandsV4(params: KCodeAgentCommandsQueryParams) {
      if (!readTrustedKCodeAgentV4Connection(params)) {
    ...
    async attachmentBeginV4(params: KCodeAgentAttachmentBeginParams) {
      const trusted = readTrustedKCodeAgentV4Connection(params);
    ...
    async attachmentChunkV4(params: KCodeAgentAttachmentChunkParams) {
      const trusted = readTrustedKCodeAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentCommitV4(params: KCodeAgentAttachmentTerminalParams) {
      const trusted = readTrustedKCodeAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentAbortV4(params: KCodeAgentAttachmentTerminalParams) {
      const trusted = readTrustedKCodeAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentReadV4(params: KCodeAgentAttachmentReadParams) {
      if (!readTrustedKCodeAgentV4Connection(params)) {
    ...
    async conversationAttachmentReadV4(params: KCodeAgentConversationAttachmentReadParams) {
      if (!readTrustedKCodeAgentV4Connection(params)) {
        throw new KCodeAttachmentFaultError(
          KCODE_ATTACHMENT_FAULT_CODES.shareReadConnectionUntrusted,
        );
      }
    ...
    async conversationAttachmentStatV4(params: KCodeAgentConversationAttachmentStatParams) {
      if (!readTrustedKCodeAgentV4Connection(params)) {
        throw new KCodeAttachmentFaultError(
          KCODE_ATTACHMENT_FAULT_CODES.shareStatConnectionUntrusted,
        );
      }
    ...
    async attachmentPreviewSourceV4(params: KCodeAgentAttachmentPreviewSourceParams) {
      const trusted = readTrustedKCodeAgentV4Connection(params);
    ...
    async conversationRowsRangeV4(params: KCodeAgentConversationRowsRangeParams) {
      const trusted = readTrustedKCodeAgentV4Connection(params);
    ...
    async conversationPlansV4(params: KCodeAgentConversationPlansParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunEventsV4(params: KCodeAgentConversationWorkflowRunEventsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunsV4(params: KCodeAgentConversationWorkflowRunsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunArtifactsV4(
      params: KCodeAgentConversationWorkflowRunArtifactsParams,
    ) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunArtifactDataV4(
      params: KCodeAgentConversationWorkflowRunArtifactDataParams,
    ) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunArtifactReadV4(
      params: KCodeAgentConversationWorkflowRunArtifactReadParams,
    ) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunWorkspaceV4(
      params: KCodeAgentConversationWorkflowRunWorkspaceParams,
    ) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunNodeResultV4(
      params: KCodeAgentConversationWorkflowRunNodeResultParams,
    ) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async backgroundBashOutputV4(params: KCodeAgentBackgroundBashOutputParams) {
      if (!readTrustedKCodeAgentV4Connection(params))
    ...
    async conversationFileChangesV4(params: KCodeAgentConversationFileChangesParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationFileRewindPreviewV4(params: KCodeAgentConversationFileRewindPreviewParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    onDynamicConversationFrame(params: KCodeAgentWorkspaceTarget) {
      return getConversationFrameEmitter(params).event;
    },

    onDynamicLocalTtftFacts(params: KCodeAgentWorkspaceTarget) {
    ...
    onDynamicConversationTelemetryFact(params: KCodeAgentWorkspaceTarget) {
    ...
    async subscribeSessionsIndexV4(params: KCodeAgentSessionsIndexSubscribeParams) {
    ...
    async unsubscribeSessionsIndexV4(params: KCodeAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "sessions-index/");
    },

    async resyncSessionsIndexV4(params: KCodeAgentConversationResyncParams) {
      return resyncV4Route(params, "sessions-index/");
    },

    onDynamicSessionsIndexFrame(params: KCodeAgentWorkspaceTarget) {
    ...
    async subscribeWorkspaceConfigV4(params: KCodeAgentWorkspaceConfigSubscribeParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const connection = resolveV4Connection(params, v4ConnectionIdFor(params.subscriberScope));
    ...
    async unsubscribeWorkspaceConfigV4(params: KCodeAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "workspace-config/");
    },

    async resyncWorkspaceConfigV4(params: KCodeAgentConversationResyncParams) {
      return resyncV4Route(params, "workspace-config/");
    },

    onDynamicWorkspaceConfigFrame(params: KCodeAgentWorkspaceTarget) {
    ...
    onAgentRuntimeLifecycle(listener: (event: KCodeAgentRuntimeLifecycleEvent) => void) {
