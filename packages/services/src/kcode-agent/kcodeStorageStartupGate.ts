...
export class KCodeStorageStartupGate {
  private current?: KCodeStorageStartupState;
  private terminalError?: Error;
  private pending?: Promise<void>;
  private resolve?: () => void;
  private reject?: (error: Error) => void;
  private timer?: ReturnType<typeof setTimeout>;
  private readonly changed = new Emitter<KCodeStorageStartupState>();
  ...
  get snapshot(): KCodeStorageStartupState | undefined {
    return this.current;
  }

  accept(input: unknown): boolean {
    const parsed = kcodeStorageStartupStateSchema.safeParse(input);
