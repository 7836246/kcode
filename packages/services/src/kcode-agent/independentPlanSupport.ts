import { kcodeProtocolMethods, kcodeRuntimeCapabilitiesSchema } from "@kcode/shared";
import type { KCodeProtocolClient } from "./kcodeProtocolClient.js";
...
export function ensureIndependentPlanSupport(
  ...
  const check = client
    .request(kcodeProtocolMethods.runtimeCapabilities, {}, kcodeRuntimeCapabilitiesSchema)
    .then((result) => {
