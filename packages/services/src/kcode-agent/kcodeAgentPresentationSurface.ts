import type { ServiceAuthorityMode } from "@kcode/shared";

export type KCodeAgentPresentationSurface = "desktop";

interface KCodeAgentPresentationHostFacts {
...
export function resolveKCodeAgentPresentationSurface(
  facts: KCodeAgentPresentationHostFacts,
): KCodeAgentPresentationSurface | undefined {
