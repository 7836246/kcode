import { resolveWorkspaceKey, type KCodeComputerUseOperationEvent } from "@kcode/shared";
...
interface CuaOperationTurnTracker {
  accept(workspace: CuaOperationWorkspaceTarget, event: KCodeComputerUseOperationEvent): void;
...
export function createCuaOperationTurnTracker(options: {
  ...
  function accept(
    workspace: CuaOperationWorkspaceTarget,
    event: KCodeComputerUseOperationEvent,
  ): void {
