import type { Hook, KCodeWorkspaceHookTrustGrantResult } from "@kcode/shared";
import type { WorkspaceHookBundleSnapshotData } from "@kcode/shared/workspace-hook-discovery";
