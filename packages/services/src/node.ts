...
import { buildLocalMediaPreviewUrl, type ProviderProvisioningTrigger } from "@kcode/shared";
...
/** Local Host 进程内能力；官方账号鉴权已下线，始终为空。 */
...
/** Local Host 私有的闲时请求鉴权装配；官方取号已下线，始终为空。 */
