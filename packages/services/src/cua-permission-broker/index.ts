...
// @kcode/kcode-cua as part of the single-package merge. This file preserves
...
//
// Why two layers:
//   - `@kcode/kcode-cua/broker/server` (51 server files) — broker server +
...
//   - `@kcode/kcode-cua/broker` (protocol) — brokerProtocol / helperErrors /
...
export * from "@kcode/kcode-cua/broker/server";
