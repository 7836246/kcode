...
import { HELPER_ADDON_ENV, WINDOWS_DEV_CONTROL_PROTOCOL } from "@kcode/kcode-cua/broker/server";
...
/**
 * Parse a `kcode-cua-windows-dev/v1` control message from the helper child.
 *
