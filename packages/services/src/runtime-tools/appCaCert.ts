...
const APP_CA_CERT_FILE = "kcode-network-ca.pem";
const APP_CA_KEY_FILE = "kcode-network-ca.key";
...
function generateSelfSignedCa(): { certPem: string; keyPem: string } {
  ...
  const attrs = [
    { name: "commonName", value: "KCode Network CA" },
    { name: "organizationName", value: "KCode" },
  ];
