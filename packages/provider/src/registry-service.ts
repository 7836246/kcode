...
export class ProviderRegistryService {
  ...
  async #runRefreshLoop(): Promise<void> {
    ...
    while (this.#completedGeneration < this.#requestedGeneration) {
      ...
      if (account.basedOnKCodeBuiltinRevision !== config.kcodeBuiltinRevision) {
      ...
      try {
        const resolution = this.#resolver.resolve({
          kcodeBuiltinProviders: config.kcodeBuiltinProviders,
          kcodeBuiltinProviderTemplates: config.kcodeBuiltinProviderTemplates,
          personalProviders: config.personalProviders,
          kcodeBuiltinModelRules: config.kcodeBuiltinModelRules,
