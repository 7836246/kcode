import { z } from "zod";
import { modelConfigDataSchema } from "@kcode/shared/model-config";
...
export function parseKCodeBuiltinProviderConfigMap(input: unknown): ProviderConfigMap {
...
export function parseKCodeBuiltinProviderConfigRules(input: unknown): {
...
export function parseKCodeBuiltinModelConfigRules(input: unknown): ModelConfigRules {
