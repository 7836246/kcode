import type { AccountProviderUnavailableReason } from "@kcode/shared/account-provider-state";
 ...
 */
export type { AccountProviderUnavailableReason } from "@kcode/shared/account-provider-state";
