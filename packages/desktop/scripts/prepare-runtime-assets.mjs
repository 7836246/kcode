...
const shouldSkipRemoteAssets = process.env.KCODE_SKIP_REMOTE_ASSETS === "1";
...
if (!shouldSkipRemoteAssets) {
  ...
  console.log("[prepare:runtime-assets] skip prepare:remote-assets (KCODE_SKIP_REMOTE_ASSETS=1)");
}
