...
export const DEV_ELECTRON_PROTOCOL_SCHEME = "kcode";
export const DEV_ELECTRON_APP_NAME = "KCode Dev";
export const DEV_ELECTRON_APP_BUNDLE_ID = "dev.kcode.app.development";
...
/**
 * 为 macOS 本地 Dev runtime 写入产品身份和 kcode URL scheme。
 * raw Electron 的 Info.plist 没有 CFBundleURLTypes，系统只能把 kcode 交给
...
export async function prepareDevElectronAppBundle({
  ...
  const sourceStampPath = join(dirname(appPath), ".kcode-dev-electron-source.json");
