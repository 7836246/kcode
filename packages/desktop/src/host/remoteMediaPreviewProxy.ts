...
import type { IFileService, IMediaPreviewService, MediaPreviewPreparation } from "@kcode/services";
import { getMediaPreviewFormat, type WindowHostAttachmentScope } from "@kcode/shared";
import {
...
const MEDIA_ROUTE_PREFIX = "/__kcode_media/";
