import {
  ...
  resolveKCodeAgentSpawnCwd,
} from "@kcode/services/storage-startup";
import type { DatabaseStartupState } from "@kcode/shared";
    ...
    prepare: async (report) => {
      ...
      try {
        ...
        for (const candidate of candidates) {
          ...
          const { cwd } = await resolveKCodeAgentSpawnCwd({
