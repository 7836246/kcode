...
import type { KCodeArchivedTaskDeletionResult } from "@kcode/services";
import {
...
export interface WindowHostControllerSessionOverlay {
  ...
  updatedAt?: number;
  pendingInteraction?: KCodeTaskMeta["pendingInteraction"];
...
export type WindowHostControllerMutationResult = void | boolean | KCodeArchivedTaskDeletionResult;
...
function defaultLiveStatus(meta: KCodeTaskMeta): WindowHostControllerTaskRow["liveStatus"] {
