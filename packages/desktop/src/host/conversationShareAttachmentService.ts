import { Event as RpcEvent } from "@kcode/rpc";
import type { IConversationShareService, IKCodeAgentService } from "@kcode/services";
import { conversationShareConnectionScopeFactory } from "@kcode/services/node";
