...
import type { BrowserPlaywrightAction, BrowserPlaywrightModifier } from "@kcode/shared";
...
const PLAYWRIGHT_WORLD_NAME = "kcode-playwright-locator";
const PLAYWRIGHT_GLOBAL = "__kcodePlaywrightInjected";
