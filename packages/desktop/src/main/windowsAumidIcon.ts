...
import type { ApplicationIconInfo } from "@kcode/shared";
...
public static class KCodeAumidIcon {
...
'@;
$kcodeIconBytes=[KCodeAumidIcon]::Read($kcodeArg0);
[Console]::Out.Write([Convert]::ToBase64String($kcodeIconBytes));
`;
