...
function mapMcpTelemetryEvent(event: Exclude<KCodeMcpTelemetryEvent, { kind: "memory" }>): {
...
function processProperties(
  event: Extract<KCodeMcpTelemetryEvent, { kind: "process_start" | "process_crash" }>,
