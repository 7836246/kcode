...
function buildLegacyCommonMcpStorageCandidates(request?: MigrateLegacyCommonMcpRequest): string[] {
  ...
  candidates.push(join(appData, "ai.z.kcode", "store.json"));

  candidates.push(
    join(localAppData, "ai.z.work", "EBWebView", "Default", "Local Storage", "leveldb"),
    join(appData, "KCode", "Local Storage", "leveldb"),
    join(appData, "KCode", "Partitions", "kcode-embedded-browser", "Local Storage", "leveldb"),
    join(appData, "KCode Dev", "Local Storage", "leveldb"),
    join(appData, "KCode Dev", "Partitions", "kcode-embedded-browser", "Local Storage", "leveldb"),
  );
