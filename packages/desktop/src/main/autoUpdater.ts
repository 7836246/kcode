...
const UPDATE_FEED_URL_ENV = "KCODE_UPDATE_FEED_URL";
const UPDATE_FEED_URL_SWITCH = "--kcode-update-feed-url";
const DEV_AUTO_UPDATE_ENV = "KCODE_AUTO_UPDATE_DEV";
const DEV_AUTO_UPDATE_SWITCH = "--kcode-auto-update-dev";
const DEV_AUTO_UPDATE_VERSION_ENV = "KCODE_AUTO_UPDATE_DEV_VERSION";
const DEV_AUTO_UPDATE_VERSION_SWITCH = "--kcode-auto-update-dev-version";
...
type UpdateDownloadedInfoLike = {
  ...
  kcodeReleaseChannel?: ElectronReleaseChannel | null;
...
function readUpdateInfoReleaseChannel(
  ...
  return info.kcodeReleaseChannel === "preview" || info.kcodeReleaseChannel === "stable"
    ? info.kcodeReleaseChannel
    : null;
}
