import { type KCodeRuntimeEnv } from "@kcode/shared";
...
export declare function buildArmsBrowserInitConfig(runtimeEnv: KCodeRuntimeEnv): {
    enable: boolean;
    version: string;
    endpoint: string;
    env: import("@kcode/shared").ArmsRumEnv;
    sessionConfig: {
        sampleRate: number;
    };
    spaMode: false;
