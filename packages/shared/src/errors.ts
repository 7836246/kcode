...
export const KCODE_FILE_LOCK_TIMEOUT_ERROR_CODE = "KCODE_FILE_LOCK_TIMEOUT" as const;
...
export function isKCodeFileLockTimeoutError(error: unknown): boolean {
  return normalizeUnknownError(error).code === KCODE_FILE_LOCK_TIMEOUT_ERROR_CODE;
}
