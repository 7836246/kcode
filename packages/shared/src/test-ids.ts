...
export const TID_SETTINGS_MANAGED_SYSTEM_ROLE_UPDATE_PRESET =
  "settings-managed-system-role-update-preset";
export const TID_SETTINGS_MANAGED_SYSTEM_ROLE_DISCARD =
  "settings-managed-system-role-discard";
/** Memory 设置模块刷新按钮 */
...
/** 模型供应商一键获取远端模型列表 */
export const TID_MODEL_PROVIDER_FETCH_MODELS_BUTTON = "model-provider-fetch-models-button";
/** 模型供应商获取模型列表后的勾选弹窗 */
export const TID_MODEL_PROVIDER_FETCH_MODELS_DIALOG = "model-provider-fetch-models-dialog";
/** 模型供应商清空当前模型列表 */
export const TID_MODEL_PROVIDER_CLEAR_MODELS_BUTTON = "model-provider-clear-models-button";
