export type BuiltinKCodeSlashCommandHelpEntry = {
...
export const BUILTIN_KCODE_SLASH_COMMAND_HELP_ENTRIES: readonly BuiltinKCodeSlashCommandHelpEntry[] =
  [
    {
      details: [
    ...
    },
    {
      details: [
        ...
        "This command targets the workspace root, not the user default ~/.kcode/AGENTS.md.",
      ],
      name: "init",
