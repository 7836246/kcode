export const KCODE_AGENT_PROVIDER_NOT_READY_CODE = "KCODE_AGENT_PROVIDER_NOT_READY" as const;
export const KCODE_AGENT_PROVIDER_NOT_READY_REASON = "provider_not_ready" as const;
