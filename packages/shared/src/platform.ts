...
export const BROWSER_VIEW_RESTORE_BOOTSTRAP_URL = "kcode-browser-restore://pending";
...
export const LOCAL_MEDIA_PREVIEW_SCHEME = "kcode-media";
...
export interface KCodeStdioTapDevState {
  enabled: boolean;
  visible: boolean;
  logDir: string;
  statePath: string;
...
export const DesktopCommandIds = {
  ...
  ToggleKCodeStdioTapDevProxy: "toggleKCodeStdioTapDevProxy",
  SetKCodeEndpointProduction: "setKCodeEndpointProduction",
  SetKCodeEndpointTest: "setKCodeEndpointTest",
  SetKCodeEndpointCustom: "setKCodeEndpointCustom",
  ResetKCodeEndpoint: "resetKCodeEndpoint",
...
export interface IPlatformService {
  ...
  /** 打开 KCode Computer Use 的完整权限引导。Desktop only。 */
  ...
  /** 注册 `kcode://share/import?code=...` 导入意图。 */
  ...
  /** 导出日志：打包 ~/.kcode/v2 及外部 agent 日志为 zip 并在系统文件浏览器中显示 */
