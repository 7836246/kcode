import type { KCodePlanStep } from "./kcode-task-types-core.js";
...
function normalizePlanStatus(value: unknown): KCodePlanStep["status"] | null {
...
function parsePlanStep(value: unknown, index: number): KCodePlanStep | null {
...
function extractPlanStepsFromValue(value: unknown): KCodePlanStep[] | null {
  ...
  const steps = collection
    ...
    .filter((step): step is KCodePlanStep => step !== null);
