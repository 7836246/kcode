 ...
 */
const INTERACTIVE_REQUIRED_BRAND = Symbol.for("kcode.mcp.oauth.interactiveAuthorizationRequired");
const TEMPORARY_REFRESH_FAILURE_BRAND = Symbol.for("kcode.mcp.oauth.temporaryRefreshFailure");
