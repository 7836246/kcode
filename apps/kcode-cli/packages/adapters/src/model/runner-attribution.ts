...
import { ModelApiActorKind, ModelApiOperation, ModelRequestSessionType } from "@kcode/contracts";
import { isOpenCodeGoBaseUrl } from "./opencode-session.js";
import type { ModelStatusContext } from "./runner-status.js";

const MODEL_TRACE_HEADER = "x-kcode-trace-id";
...
const MODEL_SESSION_TYPE_HEADER = "x-kcode-session-type";
