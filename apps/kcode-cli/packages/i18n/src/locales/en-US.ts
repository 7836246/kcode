...
export const enUS: KCodeCopy = {
  ...
  cli: {
    ...
    help: (version) => `kcode ${version}

Usage:
  kcode [command] [options]

With no command, kcode opens the full-screen TUI.

Commands:
  app-server Run the KCode Protocol stdio app server
...
`,
  ...
  tui: {
    ...
    terminal: {
      ...
      starting: "Starting KCode... Ctrl+C to exit",
    },
    transcript: {
      compact: {
