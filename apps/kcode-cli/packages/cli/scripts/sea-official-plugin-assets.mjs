...
export const seaOfficialPluginAssetPrefix = "kcode-official-plugins/";
...
export const officialSeaPlugins = [
  {
    ...
    marketplace: "kcode-plugins-official",
    name: "node-repl-host",
...
function assertPluginRoot(pluginRoot, plugin) {
  if (!existsSync(join(pluginRoot, ".kcode-plugin", "plugin.json"))) {
