...
import type { SupportedLocale, UiLocale } from "@kcode/i18n";
import type { ModelSelection, KCodeModelOption } from "@kcode/shared";
import type {
...
export type CommandCenterModelOption = KCodeModelOption;
...
export type CommandCenterApp = {
  ...
  readSubagents?: import("@kcode/tui").TuiReadSubagents;
  readSubagentTranscript?: import("@kcode/tui").TuiReadSubagentTranscript;
