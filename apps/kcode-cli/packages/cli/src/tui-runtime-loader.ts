...
import type { runTui } from "@kcode/tui";
...
const assetPrefix = "kcode-tui-runtime/";
const manifestAssetKey = `${assetPrefix}manifest.json`;
const packageEntryPath = "node_modules/@kcode/tui/dist/index.js";
