...
import type { GlobalOptions, JsonValue, RunContext } from "@kcode/shared-types";
import type {
...
export function formatHumanAvailableList(plugins: readonly KCodeAvailablePluginData[]): string {
...
export function formatHumanMarketplaceList(
  marketplaces: readonly KCodeMarketplaceSummaryData[],
): string {
...
export function formatHumanPluginSet(result: SetKCodePluginEnabledResult): string {
...
export const formatPluginSetJson = (result: SetKCodePluginEnabledResult): string =>
  formatJson({
...
export function formatAvailablePluginJson(plugin: KCodeAvailablePluginData) {
  return {
    id: plugin.id,
...
export function formatInstalledPluginJson(plugin: KCodeInstalledPluginData) {
  return {
    enabled: plugin.enabled,
    id: plugin.id,
    marketplace: plugin.marketplace,
...
export function formatMarketplaceJson(marketplace: KCodeMarketplaceSummaryData) {
  return {
    id: marketplace.id,
