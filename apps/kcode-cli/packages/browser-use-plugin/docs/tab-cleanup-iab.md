...
- IAB tabs persist for the lifetime of the current KCode process. Turn end, session end, an omitted finalize call,
...
- KCode does not restore these tabs after the KCode process exits.
