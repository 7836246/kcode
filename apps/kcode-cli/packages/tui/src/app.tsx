import type { ModelUsageSummary, TodoItem, TurnId } from "@kcode/contracts";
...
export function TuiApp({
  ...
  const initialCopy = getKCodeCopy(initialLocale).tui;
  ...
  const copy = useMemo(() => getKCodeCopy(locale), [locale]);
