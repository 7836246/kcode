...
import { SessionEventType, type SessionEvent } from "@kcode/contracts";
import type {
  KCodeSessionSubagentsResult,
  KCodeSessionRunningSubagent,
...
export type SubagentItem = KCodeSessionRunningSubagent | KCodeSessionEndedSubagent;
const EMPTY_DIRECTORY: KCodeSessionSubagentsResult = {
  revision: 0,
  childSessionIds: [],
  running: [],
  ended: { total: 0, items: [] },
