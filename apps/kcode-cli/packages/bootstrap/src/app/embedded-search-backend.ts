import type { EmbeddedSearchBackend } from "@kcode/contracts";
import { getRuntimeToolRuntime } from "@kcode/shared";

const EMBEDDED_SEARCH_COMMAND_ENV = "KCODE_EMBEDDED_SEARCH_COMMAND";
