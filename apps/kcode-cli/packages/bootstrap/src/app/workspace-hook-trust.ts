import { createDefaultFileWorkspaceHookTrustStore } from "@kcode/adapters/storage";
import {
...
import { SessionEventType } from "@kcode/contracts";
import type {
  Logger,
  SessionId,
...
import type { WorkspaceHookRuntimeRoot } from "@kcode/shared/workspace-hook-discovery";
import {
...
export function createWorkspaceHookRuntimeSecurity(input: {
  ...
  /** 测试注入临时 HOME；生产不传，Trust store 落在真实 ~/.kcode/security。 */
  homeDir?: string;
