...
import { resolveInitialModelSelection, type ModelSelectionOptions } from "@kcode/provider";
import { resolveBashTimeoutPolicy, type AgentProfile, type AgentRuntimeConfig } from "@kcode/core";
import { type BuiltInSubagentModelSelectionOverrides } from "@kcode/shared";
import {
...
export function resolveAppRuntimeConfig(input: {
  ...
  const runtimeConfig: AgentRuntimeConfig = {
    ...
    // 仅接受显式传入的会话级工具面（KCode Protocol session/create 或 CLI
