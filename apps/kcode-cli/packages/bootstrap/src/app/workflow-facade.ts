...
import { createNodeExecutionAdapter } from "@kcode/adapters/exec";
...
import type { PrepareUserExecutionBoundary, KCodeAppOptions } from "./types.js";
...
function createWorkflowChildRuntime(
  ...
  return new AgentRuntime(
    ...
    {
      ...deps.runtimeConfig,
      agentName: options.workflowKind === "expert" ? "kcode-expert" : "kcode-workflow",
      mode: "yolo",
    ...
    },
    {
      ...
      ...deps.runtime.createChildClientPorts({
        ...
        agentType: options.workflowKind === "expert" ? "kcode-expert" : "kcode-workflow",
