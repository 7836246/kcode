import type { McpServerConfig, PluginLoadOutcome } from "@kcode/contracts";
...
export function resolveBuiltInNodeReplMcpServers(input: {
  ...
  const nodeRepl = createBundledMcpRuntimeConfig({
    ...
    env: {
      ...
      ...(browserUsePackage ? { KCODE_PLUGIN_ROOT: browserUsePackage.rootPath } : {}),
      ...(cuaPackage ? { KCODE_CUA_PLUGIN_ROOT: cuaPackage.rootPath } : {}),
    },
