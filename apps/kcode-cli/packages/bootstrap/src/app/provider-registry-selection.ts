import { ModelErrorCode, ModelProtocolError } from "@kcode/contracts";
import {
...
function toModelOption(provider: Provider, model: ProviderModel): KCodeModelOption {
