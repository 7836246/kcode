...
import { SqliteSessionStore } from "@kcode/adapters/storage";
import { resolvePath, type ConfigResult } from "@kcode/adapters/config";
import {
...
import type { ModelSelection } from "@kcode/provider";
...
export async function openStartupSessionStore(
  ...
  startupTimer.start("KCode SQLite migration started", {
    context: { dbPath },
  ...
  startupTimer.mark("KCode SQLite migration completed", {
    context: { dbPath },
