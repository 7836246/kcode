...
import { digestSummary, workspaceIdentitySummary } from "@kcode/core";
import {
...
} from "@kcode/shared/workspace-hook-mutation";
...
export function createWorkspaceHookReviewMutationPort(
  ...
  const editableConfigPath = resolve(workingDirectory, ".kcode", "config.json");
