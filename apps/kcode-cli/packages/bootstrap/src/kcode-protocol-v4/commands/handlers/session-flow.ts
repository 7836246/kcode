...
import { createModelExecutionContext } from "../../../kcode-protocol/model-execution.js";
...
async function stop(
  ...
  host.logger?.info?.("v4 stop foreground execution inspected", {
    ...
    expectedForegroundExecutionId: payload.expectedForegroundExecutionId,
    module: "bootstrap.kcode_protocol_v4.commands",
...
import { resolveExecutionState } from "@kcode/shared";
