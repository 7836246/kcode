...
// 1. URI ref（kcode-artifact:// 等带 scheme:/）——经 attachment chunk transaction 寄存的内容引用：
...
import type { TurnAttachment } from "@kcode/core";
...
async function mapAttachmentRef(app: KCodeApp, ref: AttachmentRef): Promise<TurnAttachment> {
