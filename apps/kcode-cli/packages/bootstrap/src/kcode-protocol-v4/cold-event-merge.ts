...
interface PersistedConversationMaterializationStore {
  getSession(sessionId: import("@kcode/contracts").SessionId): Promise<{
    title?: string;
    revert?: {
      branchCutAfterMessageID?: import("@kcode/contracts").MessageId;
      branchGeneration?: number;
      createdMessageID?: import("@kcode/contracts").MessageId;
      keptMessageIDs?: import("@kcode/contracts").MessageId[];
      targetMessageID?: import("@kcode/contracts").MessageId;
    };
  } | null>;
  messages(input: { sessionID: import("@kcode/contracts").SessionId }): Promise<MessageWithParts[]>;
  readTarget(input: {
    sessionID: import("@kcode/contracts").SessionId;
...
export async function loadPersistedConversationMaterialization(input: {
  ...
  const sessionID = input.sessionId as import("@kcode/contracts").SessionId;
