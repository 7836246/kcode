import { parseRemoteWorkspaceIdentity, type KCodeWorkspaceRef } from "@kcode/shared";
 ...
 */
export function resolveWorkspaceRefFromId(workspaceId: string): KCodeWorkspaceRef {
