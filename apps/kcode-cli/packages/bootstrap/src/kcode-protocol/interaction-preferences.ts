import { kcodeWorkspaceUpdateInteractionPreferencesParamsSchema } from "@kcode/shared";
...
export async function updateInteractionPreferences(
  ...
  const params = parseParams(kcodeWorkspaceUpdateInteractionPreferencesParamsSchema, rawParams);
