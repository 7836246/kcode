import { kcodeWorkspaceUpdateDynamicWorkflowPolicyParamsSchema } from "@kcode/shared";
...
export async function updateDynamicWorkflowPolicy(
  ...
  const params = parseParams(kcodeWorkspaceUpdateDynamicWorkflowPolicyParamsSchema, rawParams);
