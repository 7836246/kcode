...
import { getKCodeAgentModeSelectOptions, normalizeAvailableKCodeMode } from "@kcode/shared";
import type { KCodeSessionSettingsState, KCodeSlashCommand } from "@kcode/shared";
import type { WorkspaceConfigState } from "@kcode/shared/kcode-protocol-v4";
 ...
 * 创建临时 app 并被 MCP close 拖住协议通道（见 desktop warmUpKCodeAgent 的注释）。
