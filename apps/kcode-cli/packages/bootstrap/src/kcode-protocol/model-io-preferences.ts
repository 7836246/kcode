import { kcodeWorkspaceUpdateModelIoPreferencesParamsSchema } from "@kcode/shared";
...
export async function updateModelIoPreferences(
  ...
  const params = parseParams(kcodeWorkspaceUpdateModelIoPreferencesParamsSchema, rawParams);
