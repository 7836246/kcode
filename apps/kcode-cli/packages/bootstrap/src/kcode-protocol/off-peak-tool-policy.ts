import { kcodeWorkspaceUpdateOffPeakToolPolicyParamsSchema } from "@kcode/shared";
...
export async function updateOffPeakToolPolicy(
  ...
  const params = parseParams(kcodeWorkspaceUpdateOffPeakToolPolicyParamsSchema, rawParams);
