import { expandCustomCommandPrompt, type CustomCommandContent } from "@kcode/contracts";
import { BUILTIN_KCODE_SLASH_COMMAND_HELP_ENTRIES } from "@kcode/shared";
...
const helpEntry = BUILTIN_KCODE_SLASH_COMMAND_HELP_ENTRIES.find(
