import type { PermissionOptionsPolicy, PermissionUpdate } from "@kcode/contracts";
import { OFFICIAL_CUA_PERMISSION_RULE_TOOL_NAME, type KCodePermissionOption } from "@kcode/shared";
...
export function buildProtocolPermissionOptions(
  ...
  return [
    ...
    // **没有** permissionUpdates——wire 上 kcodePermissionUpdateSchema 是 strict，会话语义由
