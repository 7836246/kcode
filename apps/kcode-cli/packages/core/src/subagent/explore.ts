...
import type { EnvInfo } from "@kcode/contracts";
...
export function buildExploreAgentPrompt(options: ExploreAgentPromptOptions): string {
  ...
  return [
    "You are KCode Explore, a file search and codebase research specialist for KCode CLI. You excel at thoroughly navigating and exploring codebases.",
    "",
