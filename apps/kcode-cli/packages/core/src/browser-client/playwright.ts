...
} from "@kcode/contracts/browser-control";
...
const locatorDetails = Symbol("kcode.playwright.locatorDetails");
const setObjectWrapper = Symbol("kcode.playwright.setObjectWrapper");
