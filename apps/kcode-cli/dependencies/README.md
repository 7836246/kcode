...
This directory contains versioned third-party artifacts required by KCode packaging.
...
pnpm --filter @kcode/desktop prepare:native-search

# Prepare a specific target, optionally into a separate staging directory.
node scripts/prepare-native-search-tools.mjs --platform linux --arch x64 --output-dir /tmp/kcode-native-search
